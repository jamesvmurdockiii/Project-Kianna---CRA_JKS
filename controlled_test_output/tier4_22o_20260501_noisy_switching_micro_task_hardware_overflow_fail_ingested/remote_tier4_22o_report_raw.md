...
- Mode: `run-hardware`
- Status: **FAIL**
- Output directory: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output`
...
| --- | --- | --- | --- |
| runner revision current | `tier4_22o_noisy_switching_micro_task_20260501_0001` | `expected current source` | yes |
...
| hardware target acquired | `{"attempts": [{"hostname": "", "method": "hostname_discovery", "notes": ["no hostname found in args, common environment variables, or spynnaker.cfg"], "reason": "no explicit hostname/config/environment target found", "status": "fail"}, {"dest_cpu": 4, "dest_x": 0, "dest_y": 0, "hostname": "10.11.209.9", "method": "pyNN.spiNNaker_probe", "notes": ["acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname", "requested dest_cpu 1 was occupied; selected free core 4"], "occupied_cores": [1, 2, 3], "probe_population_size": 1, "probe_run_ms": 1.0, "probe_timestep_ms": 1.0, "runtime_seconds": 52.797736009117216, "setup_kwargs": {"timestep": 1.0}, "status": "pass", "target_ipaddress": "10.11.209.9"}], "dest_cpu": 4, "dest_x": 0, "dest_y": 0, "hostname": "10.11.209.9", "method": "pyNN.spiNNaker_probe", "notes": ["acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname", "requested dest_cpu 1 was occupied; selected free core 4"], "occupied_cores": [1, 2, 3], "probe_population_size": 1, "probe_run_ms": 1.0, "probe_timestep_ms": 1.0, "runtime_seconds": 52.797736009117216, "setup_kwargs": {"timestep": 1.0}, "status": "pass", "target_ipaddress": "10.11.209.9"}` | `status == pass and hostname/IP/transceiver acquired` | yes |
...
| predictions match local reference | `[0, 0, 0, 0, 0, 0, 0, 0, 0, -49152, 49152, -49152, 98304, -110592]` | `abs(delta) <= 1` | no |
| weights match local reference | `[0, 0, 0, 0, 0, 0, 49152, 49152, 49152, 79872, 110592, 92160, 104448, 112128]` | `abs(delta) <= 1` | no |
| biases match local reference | `[0, 0, 0, 0, 0, 0, 0, 0, 0, 18432, 0, 18432, -18432, 23040]` | `abs(delta) <= 1` | no |
| observed tail accuracy | `0` | `>= 1.0` | no |
| observed second-half improves or matches first-half | `-0.428571` | `>= 0` | no |
| observed max pending depth | `3` | `>= 3` | yes |
| observed task metrics match reference | `{"accuracy": 0.5, "accuracy_gain": -0.4285714285714286, "correct_count": 7, "final_abs_error": 0.0, "first_half_accuracy": 0.7142857142857143, "second_half_accuracy": 0.2857142857142857, "tail_accuracy": 0.0, "tail_window": 4}` | `accuracy/tail/gain equal reference` | no |
...
| final weight matches reference | `63360` | `== -48768 +/- 1` | no |
| final bias matches reference | `21504` | `== -1536 +/- 1` | no |
...
| 7 | `1.0` | `-1.0` | `49152` | `False` | `0` | `49152` | `-6144` | `-6144` |
| 8 | `-1.0` | `1.0` | `0` | `True` | `-12288` | `36864` | `6144` | `6144` |
| 9 | `1.0` | `1.0` | `55296` | `True` | `-20736` | `28416` | `-2304` | `-2304` |
| 10 | `-1.0` | `1.0` | `-55296` | `False` | `-35328` | `44544` | `12288` | `30720` |
| 11 | `1.0` | `-1.0` | `43008` | `False` | `-45312` | `65280` | `2304` | `2304` |
| 12 | `-1.0` | `1.0` | `-30720` | `False` | `-50688` | `41472` | `7680` | `26112` |
| 13 | `1.0` | `-1.0` | `75264` | `False` | `-54336` | `50112` | `4032` | `-14400` |
| 14 | `-1.0` | `1.0` | `-62976` | `False` | `-48768` | `63360` | `-1536` | `21504` |

## Artifacts

- `reference_json`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_task_reference.json`
- `reference_csv`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_task_reference_rows.csv`
- `environment_json`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_environment.json`
- `target_acquisition_json`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_target_acquisition.json`
- `host_test_stdout`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22i_host_test_stdout.txt`
- `host_test_stderr`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22i_host_test_stderr.txt`
- `main_syntax_stdout`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22i_main_syntax_normal_stdout.txt`
- `main_syntax_stderr`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22i_main_syntax_normal_stderr.txt`
- `aplx_build_stdout`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22i_aplx_build_stdout.txt`
- `aplx_build_stderr`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22i_aplx_build_stderr.txt`
- `load_result_json`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_load_result.json`
- `task_micro_loop_result_json`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_task_micro_loop_result.json`
- `task_micro_loop_rows_csv`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_task_micro_loop_rows.csv`
- `manifest_json`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_results.json`
- `report_md`: `/tmp/job1655982067933255861.tmp/tier4_22o_job_output/tier4_22o_report.md`
