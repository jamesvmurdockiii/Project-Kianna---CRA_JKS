...
- Generated: `2026-04-28T23:34:08+00:00`
- Status: **PASS**
- Steps: `180`
- Seeds: `42`
...
- Smoke mode: `True`
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier5_10b_20260428_193408`
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| delayed_context_cue | `memory_reset` | context_control | 0 | 0.571429 | 0.166667 | 0.000720042 |
| delayed_context_cue | `online_perceptron` | linear | 0 | 0 | -0.674088 | 0.00113863 |
| delayed_context_cue | `oracle_context` | context_control | 1 | 1 | 1 | 0.000791459 |
| delayed_context_cue | `shuffled_context` | context_control | 0 | 0.428571 | None | 0.000750917 |
| delayed_context_cue | `sign_persistence` | rule | 0 | 0.571429 | 0.166667 | 0.00200396 |
| delayed_context_cue | `stream_context_memory` | context_control | 1 | 1 | 1 | 0.000974542 |
| delayed_context_cue | `wrong_context` | context_control | 0 | 0 | -1 | 0.000684792 |
| hidden_context_recurrence | `memory_reset` | context_control | 0 | 0.5 | 0 | 0.00154617 |
| hidden_context_recurrence | `online_perceptron` | linear | 0.333333 | 0.25 | -0.359172 | 0.00137275 |
| hidden_context_recurrence | `oracle_context` | context_control | 1 | 1 | 1 | 0.000715625 |
| hidden_context_recurrence | `shuffled_context` | context_control | 0.333333 | 0.5 | 0.125 | 0.00070225 |
| hidden_context_recurrence | `sign_persistence` | rule | 0 | 0.5 | 0 | 0.00102479 |
| hidden_context_recurrence | `stream_context_memory` | context_control | 1 | 1 | 1 | 0.000708208 |
| hidden_context_recurrence | `wrong_context` | context_control | 0 | 0 | -1 | 0.000740459 |
