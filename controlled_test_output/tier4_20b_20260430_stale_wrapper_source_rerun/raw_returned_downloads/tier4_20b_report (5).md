...
- Generated: `2026-04-30T03:22:29+00:00`
- Mode: `run-hardware`
- Status: **FAIL**
- Output directory: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output`
...
| --- | --- | --- | --- |
| v2.1 baseline artifact exists | `/tmp/job1038577973058361128.tmp/cra/baselines/CRA_EVIDENCE_BASELINE_v2.1.json` | `exists` | yes |
| source package import path available | `{'canonical_package': '/tmp/job1038577973058361128.tmp/cra/coral_reef_spinnaker', 'canonical_package_exists': True, 'action': 'already_canonical', 'aliases_checked': ['/tmp/job1038577973058361128.tmp/cra/coral-reef-spinnaker', '/tmp/job1038577973058361128.tmp/cra/coral reef spinnaker']}` | `coral_reef_spinnaker exists` | yes |
| Tier 4.16 child hardware runner exists | `/tmp/job1038577973058361128.tmp/cra/experiments/tier4_harder_spinnaker_capsule.py` | `exists` | yes |
...
| child Tier 4.16 manifest exists | `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/child_tier4_16/tier4_16_results.json` | `exists` | yes |
...
- `bridge_profile_json`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/tier4_20b_bridge_profile.json`
- `child_output_dir`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/child_tier4_16`
- `child_stderr_log`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/tier4_20b_child_stderr.log`
- `child_stdout_log`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/tier4_20b_child_stdout.log`
- `child_tier4_16_report.md`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/child_tier4_16/tier4_16_report.md`
- `child_tier4_16_results.json`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/child_tier4_16/tier4_16_results.json`
- `child_tier4_16_summary.csv`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/child_tier4_16/tier4_16_summary.csv`
- `child_tier4_16_task_summary.csv`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/child_tier4_16/tier4_16_task_summary.csv`
- `report_md`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/tier4_20b_report.md`
- `results_json`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/tier4_20b_results.json`
- `summary_csv`: `/tmp/job1038577973058361128.tmp/tier4_20b_job_output/tier4_20b_summary.csv`
