...
- Generated: `2026-05-08T03:05:42+00:00`
- Mode: `run-hardware`
- Status: **FAIL**
- Runner revision: `tier4_32g_multichip_lifecycle_traffic_resource_smoke_20260507_0001`
...
| --- | --- | --- | --- |
| runner revision current | `"tier4_32g_multichip_lifecycle_traffic_resource_smoke_20260507_0001"` | expected | yes |
...
| lifecycle traffic smoke status pass | `"fail"` | == pass | no |
...
| all resets succeeded | `{"learning": true, "lifecycle": true}` | all success | no |
...
| all pause commands succeeded | `{"learning": {"cmd": 25, "status": 0, "stopped_timestep": 2848, "success": true}, "lifecycle": {"cmd": 25, "payload_len": 0, "status": 255, "success": false}}` | all success | no |
