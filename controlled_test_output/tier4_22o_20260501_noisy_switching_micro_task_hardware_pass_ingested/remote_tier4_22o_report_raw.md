...
- Mode: `run-hardware`
- Status: **PASS**
- Output directory: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output`
...
- `reference_json`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_task_reference.json`
- `reference_csv`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_task_reference_rows.csv`
- `environment_json`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_environment.json`
- `target_acquisition_json`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_target_acquisition.json`
- `host_test_stdout`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22i_host_test_stdout.txt`
- `host_test_stderr`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22i_host_test_stderr.txt`
- `main_syntax_stdout`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22i_main_syntax_normal_stdout.txt`
- `main_syntax_stderr`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22i_main_syntax_normal_stderr.txt`
- `aplx_build_stdout`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22i_aplx_build_stdout.txt`
- `aplx_build_stderr`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22i_aplx_build_stderr.txt`
- `load_result_json`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_load_result.json`
- `task_micro_loop_result_json`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_task_micro_loop_result.json`
- `task_micro_loop_rows_csv`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_task_micro_loop_rows.csv`
- `manifest_json`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_results.json`
- `report_md`: `/tmp/job16989089037367810491.tmp/tier4_22o_job_output/tier4_22o_report.md`
