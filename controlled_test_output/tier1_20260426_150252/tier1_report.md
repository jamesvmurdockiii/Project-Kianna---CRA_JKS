...
- Generated: `2026-04-26T19:03:11+00:00`
- Backend: `MockSimulator`
- Overall status: **PASS**
- Steps per run: `200`
- Seed repeat count: `20`
- Base seed: `42`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier1_20260426_150252`
...
| `shuffled_label` | **PASS** | tail_strict_acc=0.526667, tail_corr=0.0511528 | criteria satisfied |
| `seed_repeat` | **PASS** | mean_tail_strict_acc=0.499, high_seed_fraction=0 | criteria satisfied |
...
| tail prediction/target abs correlation | 0.0511528 | is None or <= 0.25 | yes |
| capital absolute delta | 0.0046532 | <= 0.05 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| mean tail strict accuracy | 0.499 | <= 0.56 | yes |
| high-accuracy seed fraction | 0 | <= 0.2 | yes |
| mean absolute tail prediction/target correlation | 0.0804966 | <= 0.2 | yes |
