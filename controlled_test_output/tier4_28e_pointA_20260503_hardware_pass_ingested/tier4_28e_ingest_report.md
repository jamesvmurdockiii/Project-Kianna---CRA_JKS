...
- Status: **PASS**
- Passed: 38/38
- Hardware output: `controlled_test_output/tier4_28e_pointA_20260503_hardware_pass_ingested`
...
- ✓ hardware target acquired: `{'status': 'pass', 'method': 'pyNN.spiNNaker_probe', 'hostname': '10.11.193.17', 'target_ipaddress': '10.11.193.17', 'setup_kwargs': {'timestep': 1.0}, 'probe_population_size': 1, 'probe_run_ms': 1.0, 'probe_timestep_ms': 1.0, 'dest_x': 0, 'dest_y': 0, 'dest_cpu': 4, 'occupied_cores': [1, 2, 3], 'notes': ['acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname', 'requested dest_cpu 1 was occupied; selected free core 4'], 'runtime_seconds': 47.011038827709854, 'attempts': [{'status': 'fail', 'method': 'hostname_discovery', 'hostname': '', 'notes': ['no hostname found in args, common environment variables, or spynnaker.cfg'], 'reason': 'no explicit hostname/config/environment target found'}, {'status': 'pass', 'method': 'pyNN.spiNNaker_probe', 'hostname': '10.11.193.17', 'target_ipaddress': '10.11.193.17', 'setup_kwargs': {'timestep': 1.0}, 'probe_population_size': 1, 'probe_run_ms': 1.0, 'probe_timestep_ms': 1.0, 'dest_x': 0, 'dest_y': 0, 'dest_cpu': 4, 'occupied_cores': [1, 2, 3], 'notes': ['acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname', 'requested dest_cpu 1 was occupied; selected free core 4'], 'runtime_seconds': 47.011038827709854}]}` (status == pass)
...
- ✓ learning_core weight near reference: `-3225` (within +/- 8192 of -3225)
- ✓ learning_core bias near reference: `8530` (within +/- 8192 of 8530)
- ✓ learning_core pending_created matches reference: `64` (== 64)
- ✓ learning_core pending_matured matches reference: `64` (== 64)
- ✓ learning_core active_pending cleared: `0` (== 0)
- ✓ no unhandled hardware exception: `True` (== True)
- ✓ learning_core schema_version v2: `2` (== 2)
- ✓ learning_core lookup_requests == 192: `192` (== 192)
- ✓ learning_core lookup_replies == 192: `192` (== 192)
