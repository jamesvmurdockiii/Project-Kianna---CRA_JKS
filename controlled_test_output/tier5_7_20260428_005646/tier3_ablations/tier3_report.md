...
- Generated: `2026-04-28T04:57:06+00:00`
- Backend: `mock`
- Overall status: **PASS**
- Seeds: `42, 43, 44`
- Fixed-pattern steps: `180`
- Ecology steps: `220`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005646/tier3_ablations`
...
| `no_trophic_selection_ablation` | **PASS** | births=36, all_acc_delta=0.0909091, corr_delta=0.255835, alive_delta=12 | Ecology improves adaptation over the switch stressor. |
...
| trophic selection improves overall accuracy | 0.0909091 | >= 0.05 | yes |
| trophic selection improves prediction correlation | 0.255835 | >= 0.1 | yes |

Case aggregates:

- `intact`: tail_acc_mean=1, max_da_mean=0.999996, births_sum=36, final_alive_mean=13, final_weight_mean=-6.40876
