...
| returned EBRAINS artifact ingested | `hardware_return_ingested` | `raw remote pass OR documented false-fail correction preserved with returned artifacts copied into controlled output` | no |
