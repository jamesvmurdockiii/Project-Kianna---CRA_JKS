...
- expected_runs: `81`
- observed_runs: `81`
- candidate_min_ridge_probe_accuracy: `0.957265`
- candidate_min_knn_probe_accuracy: `0.619658`
- non_oracle_label_leakage_runs: `0`
- reward_leakage_runs: `0`
- max_abs_raw_dopamine_non_oracle: `0`
- temporal_control_losses: `2`
- non_encoder_wins: `2`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| ambiguous_reentry_context | 0.997151 | 0.894587 | 0.866097 | 0.643875 | 0.673789 | 0.673789 | 1 | 0.102564 |
| latent_cluster_sequence | 0.981499 | 0.992871 | 0.970152 | 0.998582 | 0.998582 | 0.998582 | 1 | -0.0170822 |
| temporal_motif_sequence | 0.968697 | 0.964424 | 0.967267 | 0.568976 | 0.994308 | 0.994308 | 1 | -0.0256107 |
...
| candidate reaches minimum ridge-probe accuracy | 0.957265 | >= 0.72 | yes |  |
| candidate reaches minimum kNN-probe accuracy | 0.619658 | >= 0.7 | no |  |
| candidate beats no-state-plasticity control | -0.0113719 | >= 0.05 | no |  |
| candidate beats random untrained state | 0.492877 | >= 0.2 | yes |  |
| temporal shams lose on temporal-pressure tasks | 2 | >= 2 | yes |  |
...
Failure: Failed criteria: candidate reaches minimum kNN-probe accuracy, candidate beats no-state-plasticity control, candidate improves downstream sample efficiency somewhere
