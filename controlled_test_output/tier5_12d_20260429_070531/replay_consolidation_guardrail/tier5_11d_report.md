...
- Generated: `2026-04-29T11:05:59.908300+00:00`
- Status: **PASS**
- Backend: `mock`
- Steps: `180`
- Seeds: `42`
...
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier5_12d_20260429_070531/replay_consolidation_guardrail`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| silent_context_reentry | `key_label_permuted_replay` | replay_ablation | 0.333333 | 0 | 5 | 5 | 0 | 0.413845 |
| silent_context_reentry | `no_consolidation_replay` | replay_ablation | 1 | 1 | 5 | 0 | 0 | 0.403465 |
| silent_context_reentry | `oracle_context_scaffold` | external_scaffold | 1 | 1 | 0 | 0 | 0 | 0.41264 |
| silent_context_reentry | `prioritized_replay` | replay_candidate | 1 | 1 | 5 | 5 | 0 | 0.418635 |
| silent_context_reentry | `priority_only_ablation` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.400025 |
| silent_context_reentry | `random_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.450543 |
| silent_context_reentry | `shuffled_order_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.428678 |
| silent_context_reentry | `unbounded_keyed_control` | capacity_upper_bound | 1 | 1 | 0 | 0 | 0 | 0.404464 |
| silent_context_reentry | `v1_6_no_replay` | candidate_no_replay | 1 | 1 | 0 | 0 | 0 | 0.41717 |
| silent_context_reentry | `wrong_key_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.413439 |
| silent_context_reentry | `memory_reset` |  | 1 | 1 | None | None | None | 0.000723209 |
| silent_context_reentry | `online_perceptron` |  | 0.666667 | 1 | None | None | None | 0.00115658 |
| silent_context_reentry | `oracle_context` |  | 1 | 1 | None | None | None | 0.00066125 |
| silent_context_reentry | `shuffled_context` |  | 1 | 1 | None | None | None | 0.000657584 |
| silent_context_reentry | `sign_persistence` |  | 1 | 1 | None | None | None | 0.000955 |
| silent_context_reentry | `stream_context_memory` |  | 1 | 1 | None | None | None | 0.000654542 |
| silent_context_reentry | `wrong_context` |  | 0 | 0 | None | None | None | 0.000691792 |
