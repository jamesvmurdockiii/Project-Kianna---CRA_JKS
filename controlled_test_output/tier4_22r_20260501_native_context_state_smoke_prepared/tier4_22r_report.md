...
- Generated: `2026-05-01T07:19:21+00:00`
- Mode: `prepare`
- Status: **PREPARED**
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared`
...
- jobmanager_command: `cra_422aa/experiments/tier4_22r_native_context_state_smoke.py --mode run-hardware --output-dir tier4_22r_job_output`
- upload_folder: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa`
- stable_upload_folder: `/Users/james/JKS:CRA/ebrains_jobs/cra_422aa`
- what_i_need_from_user: `Upload the generated cra_422aa folder to EBRAINS/JobManager and run the emitted command; download returned files after completion.`
...
| --- | --- | --- | --- |
| Tier 4.22q integrated bridge smoke pass exists | `pass` | `== pass` | yes |
...
| upload bundle created | `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa` | `exists` | yes |
| runtime source included | `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa/coral_reef_spinnaker/spinnaker_runtime` | `exists` | yes |
| run-hardware command emitted | `cra_422aa/experiments/tier4_22r_native_context_state_smoke.py --mode run-hardware --output-dir tier4_22r_job_output` | `contains --mode run-hardware` | yes |
...
| source native context command constants exist | `CMD_WRITE_CONTEXT/CMD_READ_CONTEXT/CMD_SCHEDULE_CONTEXT_PENDING` | `custom runtime must expose the first native v2 state primitive` | yes |
...
| source native context schedule forms feature on chip | `feature = FP_MUL(context_value, cue)` | `host must send key+cue, while the runtime retrieves context and computes the scalar feature` | yes |
...
| bundle native context command constants exist | `CMD_WRITE_CONTEXT/CMD_READ_CONTEXT/CMD_SCHEDULE_CONTEXT_PENDING` | `custom runtime must expose the first native v2 state primitive` | yes |
...
| bundle native context schedule forms feature on chip | `feature = FP_MUL(context_value, cue)` | `host must send key+cue, while the runtime retrieves context and computes the scalar feature` | yes |
...
- `reference_json`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_task_reference.json`
- `reference_csv`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_task_reference_rows.csv`
- `upload_bundle`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa`
- `job_readme`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa/README_TIER4_22R_JOB.md`
- `stable_upload_folder`: `/Users/james/JKS:CRA/ebrains_jobs/cra_422aa`
- `manifest_json`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_results.json`
- `report_md`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_report.md`
