...
- Mode: `prepare`
- Status: **PREPARED**
- Output directory: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared`
...
- upload_folder: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa`
- stable_upload_folder: `<repo>/ebrains_jobs/cra_422aa`
...
| upload bundle created | `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa` | `exists` | yes |
| runtime source included | `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa/coral_reef_spinnaker/spinnaker_runtime` | `exists` | yes |
...
- `reference_json`: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_task_reference.json`
- `reference_csv`: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_task_reference_rows.csv`
- `upload_bundle`: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa`
- `job_readme`: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/ebrains_upload_bundle/cra_422aa/README_TIER4_22R_JOB.md`
- `stable_upload_folder`: `<repo>/ebrains_jobs/cra_422aa`
- `manifest_json`: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_results.json`
- `report_md`: `<repo>/controlled_test_output/tier4_22r_20260501_native_context_state_smoke_prepared/tier4_22r_report.md`
