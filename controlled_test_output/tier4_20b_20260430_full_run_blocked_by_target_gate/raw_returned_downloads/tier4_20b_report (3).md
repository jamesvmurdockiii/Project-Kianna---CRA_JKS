...
- Generated: `2026-04-30T02:52:04+00:00`
- Mode: `run-hardware`
- Status: **FAIL**
- Output directory: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output`
...
| --- | --- | --- | --- |
| v2.1 baseline artifact exists | `/tmp/job3246262819706317367.tmp/cra/baselines/CRA_EVIDENCE_BASELINE_v2.1.json` | `exists` | yes |
| source package import path available | `{'canonical_package': '/tmp/job3246262819706317367.tmp/cra/coral_reef_spinnaker', 'canonical_package_exists': True, 'action': 'already_canonical', 'aliases_checked': ['/tmp/job3246262819706317367.tmp/cra/coral-reef-spinnaker', '/tmp/job3246262819706317367.tmp/cra/coral reef spinnaker']}` | `coral_reef_spinnaker exists` | yes |
| Tier 4.16 child hardware runner exists | `/tmp/job3246262819706317367.tmp/cra/experiments/tier4_harder_spinnaker_capsule.py` | `exists` | yes |
...
| child Tier 4.16 manifest exists | `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/child_tier4_16/tier4_16_results.json` | `exists` | yes |
...
- `bridge_profile_json`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/tier4_20b_bridge_profile.json`
- `child_output_dir`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/child_tier4_16`
- `child_stderr_log`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/tier4_20b_child_stderr.log`
- `child_stdout_log`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/tier4_20b_child_stdout.log`
- `child_tier4_16_report.md`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/child_tier4_16/tier4_16_report.md`
- `child_tier4_16_results.json`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/child_tier4_16/tier4_16_results.json`
- `child_tier4_16_summary.csv`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/child_tier4_16/tier4_16_summary.csv`
- `report_md`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/tier4_20b_report.md`
- `results_json`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/tier4_20b_results.json`
- `summary_csv`: `/tmp/job3246262819706317367.tmp/cra/tier4_20b_job_output/tier4_20b_summary.csv`
