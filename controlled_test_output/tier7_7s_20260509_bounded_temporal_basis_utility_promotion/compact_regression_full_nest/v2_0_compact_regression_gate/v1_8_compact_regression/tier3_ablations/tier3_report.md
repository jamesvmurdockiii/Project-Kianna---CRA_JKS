...
- Generated: `2026-05-09T18:04:42+00:00`
- Backend: `nest`
- Overall status: **PASS**
- Seeds: `42, 43, 44`
- Fixed-pattern steps: `180`
- Ecology steps: `220`
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier7_7s_20260509_bounded_temporal_basis_utility_promotion/compact_regression_full_nest/v2_0_compact_regression_gate/v1_8_compact_regression/tier3_ablations`
...
| `no_trophic_selection_ablation` | **PASS** | births=33, all_acc_delta=0.080303, corr_delta=0.26966, alive_delta=11 | Ecology improves adaptation over the switch stressor. |
...
| trophic selection improves overall accuracy | 0.080303 | >= 0.05 | yes |
| trophic selection improves prediction correlation | 0.26966 | >= 0.1 | yes |

Case aggregates:

- `intact`: tail_acc_mean=1, max_da_mean=0.999978, births_sum=33, final_alive_mean=12, final_weight_mean=-6.42204
