...
- Generated: `2026-04-28T04:56:14+00:00`
- Backend: `MockSimulator`
- Overall status: **PASS**
- Steps per run: `80`
- Seed repeat count: `3`
- Base seed: `42`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005610/tier1_controls`
...
| `shuffled_label` | **PASS** | tail_strict_acc=0.383333, tail_corr=-0.071794 | criteria satisfied |
| `seed_repeat` | **PASS** | mean_tail_strict_acc=0.488889, high_seed_fraction=0 | criteria satisfied |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| tail strict accuracy on nonzero targets | 0.383333 | <= 0.6 | yes |
| tail prediction/target abs correlation | 0.071794 | is None or <= 0.25 | yes |
| capital absolute delta | 0.000318571 | <= 0.05 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| mean tail strict accuracy | 0.488889 | <= 0.56 | yes |
| high-accuracy seed fraction | 0 | <= 0.2 | yes |
| mean absolute tail prediction/target correlation | 0.106374 | <= 0.2 | yes |
