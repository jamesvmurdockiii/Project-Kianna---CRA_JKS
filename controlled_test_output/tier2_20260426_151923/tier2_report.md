...
- Generated: `2026-04-26T19:19:37+00:00`
- Backend: `nest`
- Overall status: **STOPPED**
- Steps per run: `180`
- Base seed: `42`
- Fixed population: `True`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier2_20260426_151923`
...
| --- | --- | --- | --- |
| `fixed_pattern` | **PASS** | tail_acc=0.844444, weight=-0.197052 | criteria satisfied |
| `delayed_reward` | **PASS** | tail_cue_acc=1, matured=175 | criteria satisfied |
| `nonstationary_switch` | **FAIL** | pre=0.833333, post_final=0.833333, recovery=0 | Failed criteria: post-switch disruption, final inverse readout weight |
...
| learned inverse readout weight | -0.197052 | <= -0.05 | yes |
...
| delayed inverse readout weight | -0.39343 | <= -0.05 | yes |
| tail prediction/target correlation | 0.983903 | >= 0.5 | yes |
...
| post-switch disruption | 0.833333 | <= 0.45 | no |
| final post-switch accuracy | 0.833333 | >= 0.8 | yes |
| recovery time | 0 | <= 60 | yes |
| final inverse readout weight | -0.00396169 | <= -0.05 | no |
