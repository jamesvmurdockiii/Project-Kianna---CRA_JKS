...
- Generated: `2026-04-30T23:24:00+00:00`
- Mode: `run-hardware`
- Status: **FAIL**
- Output directory: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output`
...
- spinnaker_hostname: `10.11.194.49`
...
| --- | --- | --- | --- |
| runner revision current | `tier4_22i_custom_runtime_roundtrip_20260430_0008` | `expected current source` | yes |
| Tier 4.22h compact-readback pass exists or fresh bundle | `missing` | `== pass OR missing in fresh EBRAINS bundle` | yes |
| hardware target acquired | `{"attempts": [{"hostname": "", "method": "hostname_discovery", "notes": ["no hostname found in args, common environment variables, or spynnaker.cfg"], "reason": "no explicit hostname/config/environment target found", "status": "fail"}, {"dest_cpu": 4, "dest_x": 0, "dest_y": 0, "hostname": "10.11.194.49", "method": "pyNN.spiNNaker_probe", "notes": ["acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname", "requested dest_cpu 1 was occupied; selected free core 4"], "occupied_cores": [1, 2, 3], "probe_population_size": 1, "probe_run_ms": 1.0, "probe_timestep_ms": 1.0, "runtime_seconds": 48.68633571197279, "setup_kwargs": {"timestep": 1.0}, "status": "pass", "target_ipaddress": "10.11.194.49"}], "dest_cpu": 4, "dest_x": 0, "dest_y": 0, "hostname": "10.11.194.49", "method": "pyNN.spiNNaker_probe", "notes": ["acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname", "requested dest_cpu 1 was occupied; selected free core 4"], "occupied_cores": [1, 2, 3], "probe_population_size": 1, "probe_run_ms": 1.0, "probe_timestep_ms": 1.0, "runtime_seconds": 48.68633571197279, "setup_kwargs": {"timestep": 1.0}, "status": "pass", "target_ipaddress": "10.11.194.49"}` | `status == pass and hostname/IP/transceiver acquired` | yes |
...
| CMD_READ_STATE roundtrip pass | `fail` | `== pass` | no |
| reset command acknowledged | `False` | `True` | no |
| birth/synapse mutation commands acknowledged | `{"birth_1": false, "birth_2": false, "synapse": false}` | `all True` | no |
| READ_STATE schema version valid | `None` | `== 1` | no |
| READ_STATE payload compact | `2` | `== 73` | no |
...
- `environment_json`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_environment.json`
- `target_acquisition_json`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_target_acquisition.json`
- `host_test_stdout`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_host_test_stdout.txt`
- `host_test_stderr`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_host_test_stderr.txt`
- `main_syntax_stdout`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_main_syntax_normal_stdout.txt`
- `main_syntax_stderr`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_main_syntax_normal_stderr.txt`
- `aplx_build_stdout`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_aplx_build_stdout.txt`
- `aplx_build_stderr`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_aplx_build_stderr.txt`
- `load_result_json`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_load_result.json`
- `roundtrip_result_json`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_roundtrip_result.json`
- `manifest_json`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_results.json`
- `report_md`: `/tmp/job16893957533633217474.tmp/tier4_22i_job_output/tier4_22i_report.md`
