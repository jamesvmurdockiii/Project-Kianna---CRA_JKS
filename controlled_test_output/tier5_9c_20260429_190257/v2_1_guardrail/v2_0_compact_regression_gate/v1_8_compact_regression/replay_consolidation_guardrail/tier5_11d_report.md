...
- Generated: `2026-04-29T23:03:23.885332+00:00`
- Status: **PASS**
- Backend: `mock`
- Steps: `180`
- Seeds: `42`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| silent_context_reentry | `key_label_permuted_replay` | replay_ablation | 0.333333 | 0 | 5 | 5 | 0 | 0.415737 |
| silent_context_reentry | `no_consolidation_replay` | replay_ablation | 1 | 1 | 5 | 0 | 0 | 0.415608 |
| silent_context_reentry | `oracle_context_scaffold` | external_scaffold | 1 | 1 | 0 | 0 | 0 | 0.397217 |
| silent_context_reentry | `prioritized_replay` | replay_candidate | 1 | 1 | 5 | 5 | 0 | 0.440757 |
| silent_context_reentry | `priority_only_ablation` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.471783 |
| silent_context_reentry | `random_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.428812 |
| silent_context_reentry | `shuffled_order_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.41314 |
| silent_context_reentry | `unbounded_keyed_control` | capacity_upper_bound | 1 | 1 | 0 | 0 | 0 | 0.408429 |
| silent_context_reentry | `v1_6_no_replay` | candidate_no_replay | 1 | 1 | 0 | 0 | 0 | 0.480231 |
| silent_context_reentry | `wrong_key_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.405956 |
| silent_context_reentry | `memory_reset` |  | 1 | 1 | None | None | None | 0.000652 |
| silent_context_reentry | `online_perceptron` |  | 0.666667 | 1 | None | None | None | 0.00103262 |
| silent_context_reentry | `oracle_context` |  | 1 | 1 | None | None | None | 0.000649125 |
| silent_context_reentry | `shuffled_context` |  | 1 | 1 | None | None | None | 0.000730125 |
| silent_context_reentry | `sign_persistence` |  | 1 | 1 | None | None | None | 0.000966125 |
| silent_context_reentry | `stream_context_memory` |  | 1 | 1 | None | None | None | 0.000653583 |
| silent_context_reentry | `wrong_context` |  | 0 | 0 | None | None | None | 0.000652791 |
