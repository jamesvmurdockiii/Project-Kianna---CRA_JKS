...
- Generated: `2026-04-29T23:03:01+00:00`
- Backend: `MockSimulator`
- Overall status: **PASS**
- Steps per run: `80`
- Seed repeat count: `3`
- Base seed: `42`
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier5_9c_20260429_190257/v2_1_guardrail/v2_0_compact_regression_gate/v1_8_compact_regression/tier1_controls`
...
| `shuffled_label` | **PASS** | tail_strict_acc=0.583333, tail_corr=0.053973 | criteria satisfied |
| `seed_repeat` | **PASS** | mean_tail_strict_acc=0.55, high_seed_fraction=0 | criteria satisfied |
...
| tail accuracy EMA | 0.396492 | <= 0.51 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| tail strict accuracy on nonzero targets | 0.583333 | <= 0.6 | yes |
| tail prediction/target abs correlation | 0.053973 | is None or <= 0.25 | yes |
| capital absolute delta | 0.0158271 | <= 0.05 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| mean tail strict accuracy | 0.55 | <= 0.56 | yes |
| high-accuracy seed fraction | 0 | <= 0.2 | yes |
| mean absolute tail prediction/target correlation | 0.04597 | <= 0.2 | yes |
