...
- Generated: `2026-04-26T19:35:42+00:00`
- Backend: `nest`
- Overall status: **STOPPED**
- Steps per run: `180`
- Base seed: `42`
- Fixed population: `True`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier2_20260426_153522`
...
| `nonstationary_switch` | **FAIL** | pre=0.541667, post_final=0.791667, recovery=0 | Failed criteria: pre-switch accuracy, final post-switch accuracy |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| pre-switch accuracy | 0.541667 | >= 0.8 | no |
| post-switch disruption | 0.791667 | <= 0.9 | yes |
| final post-switch accuracy | 0.791667 | >= 0.8 | no |
| recovery time | 0 | <= 60 | yes |
| final inverse readout weight | -0.146396 | <= 0 | yes |
