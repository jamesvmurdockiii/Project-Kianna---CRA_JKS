...
Upload the `cra_428f` folder itself so the JobManager path starts
with `cra_428f/`.
...
```text
cra_428f/experiments/tier4_28b_delayed_cue_four_core_mcpl.py --mode run-hardware --seed 42
```

Default output dir is `tier4_28b_seed42_job_output`.
