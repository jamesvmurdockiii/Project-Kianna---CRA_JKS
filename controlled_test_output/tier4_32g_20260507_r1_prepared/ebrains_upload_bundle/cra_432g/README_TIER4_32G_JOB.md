...
Upload the `cra_432g` folder itself so the JobManager path starts with `cra_432g/`. Do not upload `controlled_test_output`, the full repo, Downloads, or compiled host-test binaries.
