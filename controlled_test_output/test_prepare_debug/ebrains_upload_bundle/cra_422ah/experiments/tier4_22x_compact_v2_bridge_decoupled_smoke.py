...
Tier 4.22x proved that the custom runtime can execute independent-key decoupled
...
def prepare_bundle(output_dir: Path) -> tuple[Path, str, dict[str, str]]:
    ...
    for script in [
        ...
        "tier4_22u_bridge_memory_route_state_smoke.py",
        "tier4_22t_native_keyed_route_state_smoke.py",
        "tier4_22s_bridge_route_state_smoke.py",
        "tier4_22r_bridge_context_state_smoke.py",
