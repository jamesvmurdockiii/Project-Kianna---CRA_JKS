...
- upload_bundle: `<repo>/controlled_test_output/tier4_32a_hw_replicated_20260507_prepared/ebrains_upload_bundle/cra_432a_rep`
- stable_upload_folder: `<repo>/ebrains_jobs/cra_432a_rep`
...
| upload bundle created | `"<repo>/controlled_test_output/tier4_32a_hw_replicated_20260507_prepared/ebrains_upload_bundle/cra_432a_rep"` | exists | yes |
| stable upload folder created | `"<repo>/ebrains_jobs/cra_432a_rep"` | exists | yes |
