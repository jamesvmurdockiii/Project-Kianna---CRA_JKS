...
#define EOC_HIDDEN_UNITS          64       // default 64 (16KB w_rec DTCM)
#define EOC_MAX_HIDDEN            128      // hard ceiling
#define EOC_INPUT_DIM             16       // bias + obs + 7 EMAs + 6 deltas + novelty
#define EOC_WRITE_STATE           43       // host writes EOC w_rec/w_in/decay
#define EOC_READ_STATE            44       // host reads EOC compact state
#define EOC_TANH_LOOKUP_SIZE      1024     // tanh lookup table entries
...
#define PROFILE_EOC_RECURRENT          7
