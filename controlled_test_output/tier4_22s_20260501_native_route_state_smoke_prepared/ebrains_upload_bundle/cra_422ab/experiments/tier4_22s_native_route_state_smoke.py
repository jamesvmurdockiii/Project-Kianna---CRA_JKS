...
def task_micro_loop(hostname: str, args: argparse.Namespace, *, dest_cpu: int, reference: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        ok = (
            ...
            and int_or(final_route_state.get("route_writes"), -1) == int(reference.get("native_route", {}).get("route_writes") or -2)
...
def run_hardware(args: argparse.Namespace, output_dir: Path) -> int:
    ...
    criteria = [
        ...
        *_source_checks_for_root(ROOT, label="runtime"),
        ...
        criterion("route writes final", final_route_state.get("route_writes"), f"== {reference.get('native_route', {}).get('route_writes')}", int_or(final_route_state.get("route_writes"), -1) == int(reference.get("native_route", {}).get("route_writes") or -2)),
    ...
    result = {
        ...
        "summary": {
            ...
            **bridge_summary(reference),
            ...
            "final_route_writes": final_route_state.get("route_writes"),
