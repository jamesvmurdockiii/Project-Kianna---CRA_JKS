...
- Generated: `2026-05-09T17:17:47.151749+00:00`
- Registry status: **PASS**
- Canonical evidence entries: `139`
- Expanded test-entry count: `139`; see the canonical evidence table below for the exact current tier list.
...
| `tier7_0i_recurrence_topology_specificity_gate` | **PASS** | `controlled_test_output/tier7_0i_20260508_recurrence_topology_specificity_gate` | Software evidence only; not a baseline freeze, not hardware evidence, not ESN superiority, not native on-chip recurrence, and not a topology-specific recurrence claim. |
| `tier7_0j_generic_recurrent_promotion_gate` | **PASS** | `controlled_test_output/tier7_0j_20260508_generic_recurrent_promotion_gate` | Software evidence only; not topology-specific recurrence, not ESN superiority, not hardware evidence, not native/on-chip recurrence, not language, planning, AGI, or ASI. |
| `tier6_2a_targeted_usefulness_validation` | **PASS** | `controlled_test_output/tier6_2a_20260508_targeted_usefulness_validation` | Software diagnostic evidence only; custom hard tasks cannot make the public usefulness claim, and the result is not a baseline freeze, hardware evidence, native transfer, ESN superiority, or AGI/ASI evidence. |
| `tier7_1a_realish_adapter_contract` | **PASS** | `controlled_test_output/tier7_1a_20260508_realish_adapter_contract` | Contract evidence only; not a dataset run, not public usefulness evidence, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. |
| `tier7_1b_cmapss_source_data_preflight` | **PASS** | `controlled_test_output/tier7_1b_20260508_cmapss_source_data_preflight` | Preflight evidence only; not C-MAPSS scoring, not public usefulness evidence, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. |
...
| `tier7_5c_curriculum_environment_scoring_gate` | **PASS** | `controlled_test_output/tier7_5c_20260509_curriculum_environment_scoring_gate` | Synthetic generated-family scoring only; not public real-world usefulness proof, not a mechanism promotion by itself, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. Because the generator grammar is aligned with keyed/compositional features, Tier 7.5d attribution/promotion is required before any stronger claim. |
| `tier7_5d_curriculum_environment_attribution_closeout` | **PASS** | `controlled_test_output/tier7_5d_20260509_curriculum_environment_attribution_closeout` | Attribution/decision evidence only; not new performance scoring, not public real-world usefulness proof, not a new software baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. |
| `tier7_6a_long_horizon_planning_contract` | **PASS** | `controlled_test_output/tier7_6a_20260509_long_horizon_planning_contract` | Contract evidence only; not planning performance, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. |
| `tier7_6b_long_horizon_planning_local_diagnostic` | **PASS** | `controlled_test_output/tier7_6b_20260509_long_horizon_planning_local_diagnostic` | Local software diagnostic scaffold only; not a promoted CRA mechanism, not broad planning, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. |
| `tier7_6c_long_horizon_planning_attribution_closeout` | **PASS** | `controlled_test_output/tier7_6c_20260509_long_horizon_planning_attribution_closeout` | Attribution/decision evidence only; not new performance scoring, not a promoted planning mechanism, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. |
...
| `tier7_7c_standardized_long_run_failure_contract` | **PASS** | `controlled_test_output/tier7_7c_20260509_standardized_long_run_failure_contract` | Contract/pre-registration evidence only; not a long-run score, not a baseline freeze, not public usefulness proof, not hardware/native transfer, and not language, broad planning, AGI, or ASI evidence. |
| `tier7_7d_standardized_long_run_failure_scoring_gate` | **PASS** | `controlled_test_output/tier7_7d_20260509_standardized_long_run_failure_scoring_gate` | Scoring-blocker evidence only; not a complete long-run scoreboard, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not language, broad planning, AGI, or ASI evidence. NARMA10 long-run generation must be repaired/preflighted before citable long-run standardized scoring. |
| `tier7_7e_finite_stream_repair_preflight` | **PASS** | `controlled_test_output/tier7_7e_20260509_finite_stream_repair_preflight` | Benchmark repair/preflight evidence only; not a CRA score, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not permission to silently merge repaired U(0,0.2) NARMA results with prior U(0,0.5) NARMA scores. |
| `tier7_7f_repaired_finite_stream_long_run_scoreboard` | **PASS** | `controlled_test_output/tier7_7f_20260509_repaired_finite_stream_long_run_scoreboard` | Scoring evidence only; not a baseline freeze, not hardware/native evidence, not broad public usefulness, not external-baseline superiority, and not permission to mix repaired U(0,0.2) NARMA scores with prior U(0,0.5) NARMA scores. |
| `tier7_7g_lorenz_capacity_narma_memory_contract` | **PASS** | `controlled_test_output/tier7_7g_20260509_lorenz_capacity_narma_memory_contract` | Contract/pre-registration evidence only; not a score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, and not broad public usefulness evidence. |
| `tier7_7h_lorenz_capacity_narma_memory_scoring_gate` | **PASS** | `controlled_test_output/tier7_7h_20260509_lorenz_capacity_narma_memory_scoring_gate` | Scoring evidence only; not a baseline freeze, not a mechanism promotion, not hardware/native evidence, not public usefulness evidence, and not external-baseline superiority. |
...
| `tier7_7m_partitioned_driver_attribution_contract` | **PASS** | `controlled_test_output/tier7_7m_20260509_partitioned_driver_attribution_contract` | Contract evidence only; not an attribution implementation, not a model score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence. |
| `tier7_7n_partitioned_driver_attribution_scoring_gate` | **PASS** | `controlled_test_output/tier7_7n_20260509_partitioned_driver_attribution_scoring_gate` | Diagnostic scoring evidence only; not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence. |
