...
- Mode: `prepare`
- Status: **PREPARED**
- Output directory: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared`
...
- upload_folder: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/ebrains_upload_bundle/cra_422ae`
- stable_upload_folder: `<repo>/ebrains_jobs/cra_422ae`
...
| upload bundle created | `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/ebrains_upload_bundle/cra_422ae` | `exists` | yes |
| runtime source included | `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/ebrains_upload_bundle/cra_422ae/coral_reef_spinnaker/spinnaker_runtime` | `exists` | yes |
...
- `reference_json`: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/tier4_22v_task_reference.json`
- `reference_csv`: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/tier4_22v_task_reference_rows.csv`
- `upload_bundle`: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/ebrains_upload_bundle/cra_422ae`
- `job_readme`: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/ebrains_upload_bundle/cra_422ae/README_TIER4_22V_JOB.md`
- `stable_upload_folder`: `<repo>/ebrains_jobs/cra_422ae`
- `manifest_json`: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/tier4_22v_results.json`
- `report_md`: `<repo>/controlled_test_output/tier4_22v_20260501_native_memory_route_reentry_composition_smoke_prepared/tier4_22v_report.md`
