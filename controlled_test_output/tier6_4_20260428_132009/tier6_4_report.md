...
- Generated: `2026-04-28T18:31:46+00:00`
- Backend: `nest`
- Status: **FAIL**
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier6_4_20260428_132009`
...
- random_or_monolithic_domination_count: `2`
...
| random/monolithic controls do not dominate intact | 2 | <= 0 | no |
| motif-shuffled control emitted | 2 | >= 2 | yes |
| WTA/lateral-inhibition ablation emitted | 2 | >= 2 | yes |

Failure: Failed criteria: random/monolithic controls do not dominate intact
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| `hard_noisy_switching` | `life4_16` | `monolithic_same_capacity` | -0.0294118 | -0.0500712 | 3.20588 | 0.0428916 | yes | `switch_recovery_loss,active_population_efficiency_loss` | yes |
...
| `hard_noisy_switching` | `life8_32` | `monolithic_same_capacity` | -0.0588235 | -0.0688837 | 2.86765 | 0.033843 | yes | `switch_recovery_loss,active_population_efficiency_loss` | yes |
