...
- Mode: `prepare`
- Status: **PREPARED**
- Output directory: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared`
...
- upload_folder: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/ebrains_upload_bundle/cra_422x`
- stable_upload_folder: `<repo>/ebrains_jobs/cra_422x`
...
| upload bundle created | `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/ebrains_upload_bundle/cra_422x` | `exists` | yes |
| runtime source included | `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/ebrains_upload_bundle/cra_422x/coral_reef_spinnaker/spinnaker_runtime` | `exists` | yes |
...
- `reference_json`: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/tier4_22o_task_reference.json`
- `reference_csv`: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/tier4_22o_task_reference_rows.csv`
- `upload_bundle`: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/ebrains_upload_bundle/cra_422x`
- `job_readme`: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/ebrains_upload_bundle/cra_422x/README_TIER4_22O_JOB.md`
- `stable_upload_folder`: `<repo>/ebrains_jobs/cra_422x`
- `manifest_json`: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/tier4_22o_results.json`
- `report_md`: `<repo>/controlled_test_output/tier4_22o_20260501_noisy_switching_micro_task_prepared/tier4_22o_report.md`
