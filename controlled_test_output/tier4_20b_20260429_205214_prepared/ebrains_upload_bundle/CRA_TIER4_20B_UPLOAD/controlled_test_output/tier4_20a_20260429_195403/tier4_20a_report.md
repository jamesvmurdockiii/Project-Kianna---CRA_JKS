...
- Generated: `2026-04-29T23:54:03+00:00`
- Status: **PASS**
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier4_20a_20260429_195403`
...
| macro eligibility residual trace | `not_promoted` | `future_custom_runtime_if_promoted` | `not_implemented` | `low_until_promoted` | `high` | do not port; revive only if a future measured blocker specifically requires macro eligibility and the trace beats shuffled/zero controls |
...
1. Keep macro eligibility parked after the failed Tier 5.9c v2.1-era recheck; do not include it in hardware probes.
2. Run Tier 4.20b one-seed v2.1 chunked hardware probe using delayed/context/predictive/self-evaluation-compatible mechanisms only.
