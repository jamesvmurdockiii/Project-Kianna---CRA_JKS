...
class TestSDPPacketFormat(unittest.TestCase):
    ...
    def test_packet_length(self):
        ...
        pkt = ctrl._build_sdp(1, b"\x00\x00\x00\x2a")  # birth neuron 42
        # 2 pad + 8 header + 1 cmd + 4 payload = 15 bytes
    ...
    def test_header_layout(self):
        ...
        # byte 10 : first payload byte = cmd
        self.assertEqual(pkt[10], 3)
    ...
    def test_reply_parsing(self):
        ...
        raw += struct.pack("<2B", 1, 0)  # payload: cmd=1, status=0 (success)
