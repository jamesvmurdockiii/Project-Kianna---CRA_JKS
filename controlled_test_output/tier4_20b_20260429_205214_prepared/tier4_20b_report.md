...
- `ebrains_upload_bundle/CRA_TIER4_20B_UPLOAD.zip`
- entrypoint: `run.py`
- command: `python3 run.py`
- default output directory: `tier4_20b_job_output`

The bundle includes `experiments/`, `coral_reef_spinnaker/`, the v2.1 baseline artifact, and the Tier 4.20a audit pointer required by the preflight checks.
