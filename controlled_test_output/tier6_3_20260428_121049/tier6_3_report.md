...
- Generated: `2026-04-28T16:10:50+00:00`
- Backend: `mock`
- Status: **PASS**
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier6_3_20260428_121049`
...
- performance_control_win_count: `1`
...
| intact beats performance shams | 1 | >= 0 | yes |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `hard_noisy_switching` | `life4_16` | `fixed_initial` | `capacity_control` | 0 | 0.533852 | 17.5 | 0 | 4 | 0 |
| `hard_noisy_switching` | `life4_16` | `fixed_max` | `capacity_control` | 0 | 0.534551 | 17.5 | 0 | 16 | 0 |
| `hard_noisy_switching` | `life4_16` | `intact` | `intact` | 0 | 0.540242 | 17.5 | 5 | 7.45 | 0 |
| `hard_noisy_switching` | `life4_16` | `lineage_id_shuffle` | `lineage_shuffle` | 0 | 0.540242 | 17.5 | 5 | 7.45 | 1 |
| `hard_noisy_switching` | `life4_16` | `random_event_replay` | `event_replay_sham` | 0 | 0.533852 | 17.5 | 5 | 4 | 0 |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `hard_noisy_switching` | `life4_16` | `fixed_initial` | 0 | 0.00639029 | 0 | -0.0426842 | no | `` |
| `hard_noisy_switching` | `life4_16` | `fixed_max` | 0 | 0.00569081 | 0 | 0.0198156 | yes | `active_population_efficiency` |
| `hard_noisy_switching` | `life4_16` | `lineage_id_shuffle` | 0 | 0 | 0 | 0 | no | `` |
| `hard_noisy_switching` | `life4_16` | `random_event_replay` | 0 | 0.00639029 | 0 | -0.0426842 | no | `` |
