...
- Output directory: `<repo>/controlled_test_output/tier5_7_20260428_214807`
...
| --- | --- | ---: | ---: | --- | --- |
| `tier1_controls` | **PASS** | 0 | 17.518 | negative controls stay negative under the promoted learning setting | `<repo>/controlled_test_output/tier5_7_20260428_214807/tier1_controls/tier1_results.json` |
| `tier2_learning` | **PASS** | 0 | 16.094 | positive learning controls still pass under the promoted setting | `<repo>/controlled_test_output/tier5_7_20260428_214807/tier2_learning/tier2_results.json` |
| `tier3_ablations` | **PASS** | 0 | 111.023 | core mechanism ablation gaps remain meaningful under the promoted setting | `<repo>/controlled_test_output/tier5_7_20260428_214807/tier3_ablations/tier3_results.json` |
| `target_task_smokes` | **PASS** | 0 | 9.318 | delayed_cue and hard_noisy_switching smoke matrix still executes with CRA locked | `<repo>/controlled_test_output/tier5_7_20260428_214807/target_task_smokes/tier5_6_results.json` |
