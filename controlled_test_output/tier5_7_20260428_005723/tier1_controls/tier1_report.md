...
- Generated: `2026-04-28T04:57:40+00:00`
- Backend: `MockSimulator`
- Overall status: **PASS**
- Steps per run: `200`
- Seed repeat count: `20`
- Base seed: `42`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005723/tier1_controls`
...
| `shuffled_label` | **PASS** | tail_strict_acc=0.48, tail_corr=-0.0277865 | criteria satisfied |
| `seed_repeat` | **PASS** | mean_tail_strict_acc=0.500667, high_seed_fraction=0 | criteria satisfied |
...
| tail accuracy EMA | 0.209111 | <= 0.51 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| tail strict accuracy on nonzero targets | 0.48 | <= 0.6 | yes |
| tail prediction/target abs correlation | 0.0277865 | is None or <= 0.25 | yes |
| capital absolute delta | 0.0160114 | <= 0.05 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| mean tail strict accuracy | 0.500667 | <= 0.56 | yes |
| high-accuracy seed fraction | 0 | <= 0.2 | yes |
| mean absolute tail prediction/target correlation | 0.0759006 | <= 0.2 | yes |
