...
- Generated: `2026-04-28T05:00:02+00:00`
- Status: **PASS**
- Backend: `nest`
- Promoted setting: `readout_lr=0.1`, `delayed_readout_lr=0.2`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005723`
...
| --- | --- | ---: | ---: | --- | --- |
| `tier1_controls` | **PASS** | 0 | 17.549 | negative controls stay negative under the promoted learning setting | `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005723/tier1_controls/tier1_results.json` |
| `tier2_learning` | **PASS** | 0 | 15.965 | positive learning controls still pass under the promoted setting | `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005723/tier2_learning/tier2_results.json` |
| `tier3_ablations` | **PASS** | 0 | 116.851 | core mechanism ablation gaps remain meaningful under the promoted setting | `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005723/tier3_ablations/tier3_results.json` |
| `target_task_smokes` | **PASS** | 0 | 8.888 | delayed_cue and hard_noisy_switching smoke matrix still executes with CRA locked | `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_7_20260428_005723/target_task_smokes/tier5_6_results.json` |
