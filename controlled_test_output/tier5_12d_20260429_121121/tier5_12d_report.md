...
- Output directory: `<repo>/controlled_test_output/tier5_12d_20260429_121121`
...
| --- | --- | ---: | ---: | --- | --- |
| `tier1_controls` | **PASS** | 0 | 3.570 | negative controls stay negative under the candidate v1.8 predictive-context baseline | `<repo>/controlled_test_output/tier5_12d_20260429_121121/tier1_controls/tier1_results.json` |
| `tier2_learning` | **PASS** | 0 | 3.071 | positive learning controls still pass under the candidate v1.8 predictive-context baseline | `<repo>/controlled_test_output/tier5_12d_20260429_121121/tier2_learning/tier2_results.json` |
| `tier3_ablations` | **PASS** | 0 | 11.115 | core mechanism ablation gaps remain meaningful under the candidate v1.8 predictive-context baseline | `<repo>/controlled_test_output/tier5_12d_20260429_121121/tier3_ablations/tier3_results.json` |
| `target_task_smokes` | **PASS** | 0 | 1.900 | delayed_cue and hard_noisy_switching smoke matrix still executes with the carried-forward CRA path | `<repo>/controlled_test_output/tier5_12d_20260429_121121/target_task_smokes/tier5_6_results.json` |
| `replay_consolidation_guardrail` | **PASS** | 0 | 5.820 | v1.7 replay/consolidation mechanism still passes a compact bounded-memory guardrail | `<repo>/controlled_test_output/tier5_12d_20260429_121121/replay_consolidation_guardrail/tier5_11d_results.json` |
| `predictive_context_guardrail` | **PASS** | 0 | 7.594 | Tier 5.12c predictive-context candidate still beats shams on a compact predictive task matrix | `<repo>/controlled_test_output/tier5_12d_20260429_121121/predictive_context_guardrail/tier5_12c_results.json` |
