...
- Mode: `run-hardware`
- Status: **PASS**
- Output directory: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output`
...
- spinnaker_hostname: `10.11.236.73`
- selected_dest_cpu: `4`
...
- bridge_context_keys: `["ctx_A", "ctx_B", "ctx_C", "ctx_D"]`
- bridge_context_key_ids: `[101, 202, 303, 404]`
- bridge_context_writes: `12`
- bridge_context_reads: `48`
- bridge_context_max_slot_count: `4`
- bridge_route_keys: `["route_A", "route_B", "route_C", "route_D"]`
- bridge_route_key_ids: `[1101, 1202, 1303, 1404]`
- bridge_route_slot_writes: `12`
- bridge_route_slot_reads: `48`
- bridge_route_max_slot_count: `4`
- bridge_route_values: `[-1, 1]`
- bridge_feature_source: `chip_decoupled_context_route_memory_lookup_feature_transform`
- bridge_memory_keys: `["mem_A", "mem_B", "mem_C", "mem_D"]`
- bridge_memory_key_ids: `[2101, 2202, 2303, 2404]`
- bridge_memory_slot_writes: `12`
- bridge_memory_slot_reads: `48`
- bridge_memory_max_slot_count: `4`
- bridge_memory_values: `[-1, 1]`
...
| --- | --- | --- | --- |
| runner revision current | `tier4_22x_compact_v2_bridge_decoupled_smoke_20260501_0001` | `expected current source` | yes |
| Tier 4.22w native decoupled memory-route composition smoke pass exists or fresh bundle | `missing` | `== pass OR missing in fresh EBRAINS bundle` | yes |
| local task fixed-point reference generated | `pass` | `== pass` | yes |
| reference native context writes observed | `12` | `> 0` | yes |
| reference native context reads observed | `48` | `== 48` | yes |
| reference native context retained four keyed slots | `4` | `>= 4` | yes |
| reference native keyed route writes observed | `12` | `> 0` | yes |
...
| reference native keyed memory writes observed | `12` | `> 0` | yes |
...
| hardware target acquired | `{"attempts": [{"hostname": "", "method": "hostname_discovery", "notes": ["no hostname found in args, common environment variables, or spynnaker.cfg"], "reason": "no explicit hostname/config/environment target found", "status": "fail"}, {"dest_cpu": 4, "dest_x": 0, "dest_y": 0, "hostname": "10.11.236.73", "method": "pyNN.spiNNaker_probe", "notes": ["acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname", "requested dest_cpu 1 was occupied; selected free core 4"], "occupied_cores": [1, 2, 3], "probe_population_size": 1, "probe_run_ms": 1.0, "probe_timestep_ms": 1.0, "runtime_seconds": 46.779971378156915, "setup_kwargs": {"timestep": 1.0}, "status": "pass", "target_ipaddress": "10.11.236.73"}], "dest_cpu": 4, "dest_x": 0, "dest_y": 0, "hostname": "10.11.236.73", "method": "pyNN.spiNNaker_probe", "notes": ["acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname", "requested dest_cpu 1 was occupied; selected free core 4"], "occupied_cores": [1, 2, 3], "probe_population_size": 1, "probe_run_ms": 1.0, "probe_timestep_ms": 1.0, "runtime_seconds": 46.779971378156915, "setup_kwargs": {"timestep": 1.0}, "status": "pass", "target_ipaddress": "10.11.236.73"}` | `status == pass and hostname/IP/transceiver acquired` | yes |
...
| all context writes succeeded | `[true, true, true, true, true, true, true, true, true, true, true, true]` | `all True` | yes |
| all route-slot writes succeeded | `[true, true, true, true, true, true, true, true, true, true, true, true]` | `all True` | yes |
| all memory-slot writes succeeded | `[true, true, true, true, true, true, true, true, true, true, true, true]` | `all True` | yes |
...
| context slot writes final | `12` | `== 12` | yes |
...
| observed route-slot writes final | `12` | `== 12` | yes |
...
| observed memory-slot writes final | `12` | `== 12` | yes |
...
| 3 | `1.0` | `1.0` | `0` | `True` | `24576` | `24576` | `8192` | `8192` |
| 4 | `-1.0` | `-1.0` | `0` | `False` | `32768` | `32768` | `0` | `0` |
| 5 | `-1.0` | `-1.0` | `-16384` | `True` | `36864` | `36864` | `-4096` | `-4096` |
| 6 | `1.0` | `1.0` | `32768` | `True` | `36864` | `36864` | `-4096` | `-4096` |
| 7 | `-1.0` | `-1.0` | `-32768` | `True` | `36864` | `36864` | `-4096` | `-4096` |
| 8 | `1.0` | `1.0` | `32768` | `True` | `36864` | `36864` | `-4096` | `-4096` |
| 9 | `-1.0` | `-1.0` | `-40960` | `True` | `34816` | `34816` | `-2048` | `-2048` |
| 10 | `1.0` | `1.0` | `32768` | `True` | `34816` | `34816` | `-2048` | `-2048` |
...
- `reference_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_task_reference.json`
- `reference_csv`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_task_reference_rows.csv`
- `environment_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_environment.json`
- `target_acquisition_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_target_acquisition.json`
- `host_test_stdout`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22i_host_test_stdout.txt`
- `host_test_stderr`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22i_host_test_stderr.txt`
- `main_syntax_stdout`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22i_main_syntax_normal_stdout.txt`
- `main_syntax_stderr`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22i_main_syntax_normal_stderr.txt`
- `aplx_build_stdout`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22i_aplx_build_stdout.txt`
- `aplx_build_stderr`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22i_aplx_build_stderr.txt`
- `runtime_profile_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_runtime_profile.json`
- `load_result_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_load_result.json`
- `task_micro_loop_result_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_task_micro_loop_result.json`
- `task_micro_loop_rows_csv`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_task_micro_loop_rows.csv`
- `manifest_json`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_results.json`
- `report_md`: `/tmp/job10947564092789900545.tmp/tier4_22x_job_output/tier4_22x_report.md`
