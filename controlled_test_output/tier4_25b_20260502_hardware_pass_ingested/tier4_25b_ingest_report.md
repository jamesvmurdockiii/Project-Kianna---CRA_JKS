# Tier 4.25B — Two-Core State/Learning Split Smoke — Ingest Report

- Status: **PASS**
- Passed: 23/23
- Hardware output: `controlled_test_output/tier4_25b_20260502_hardware_pass_ingested`

## Criteria

- ✓ runner revision current: `tier4_25b_two_core_split_smoke_20260502_0004` (expected current source)
- ✓ custom C host tests pass: `pass` (== pass)
- ✓ main.c syntax check pass: `pass` (== pass)
- ✓ hardware target acquired: `{'status': 'pass', 'method': 'pyNN.spiNNaker_probe', 'hostname': '10.11.205.161', 'target_ipaddress': '10.11.205.161', 'setup_kwargs': {'timestep': 1.0}, 'probe_population_size': 1, 'probe_run_ms': 1.0, 'probe_timestep_ms': 1.0, 'dest_x': 0, 'dest_y': 0, 'dest_cpu': 4, 'occupied_cores': [1, 2, 3], 'notes': ['acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname', 'requested dest_cpu was free'], 'runtime_seconds': 45.373495555948466, 'attempts': [{'status': 'fail', 'method': 'hostname_discovery', 'hostname': '', 'notes': ['no hostname found in args, common environment variables, or spynnaker.cfg'], 'reason': 'no explicit hostname/config/environment target found'}, {'status': 'pass', 'method': 'pyNN.spiNNaker_probe', 'hostname': '10.11.205.161', 'target_ipaddress': '10.11.205.161', 'setup_kwargs': {'timestep': 1.0}, 'probe_population_size': 1, 'probe_run_ms': 1.0, 'probe_timestep_ms': 1.0, 'dest_x': 0, 'dest_y': 0, 'dest_cpu': 4, 'occupied_cores': [1, 2, 3], 'notes': ['acquired transceiver/IP via PyNN/sPyNNaker DataView because EBRAINS JobManager may not expose a raw hostname', 'requested dest_cpu was free'], 'runtime_seconds': 45.373495555948466}]}` (status == pass)
