...
- Generated: `2026-04-26T19:10:00+00:00`
- Backend: `MockSimulator`
- Overall status: **PASS**
- Steps per run: `200`
- Seed repeat count: `20`
- Base seed: `42`
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier1_20260426_150944`
...
| `shuffled_label` | **PASS** | tail_strict_acc=0.486667, tail_corr=-0.0355503 | criteria satisfied |
| `seed_repeat` | **PASS** | mean_tail_strict_acc=0.492333, high_seed_fraction=0 | criteria satisfied |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| tail strict accuracy on nonzero targets | 0.486667 | <= 0.6 | yes |
| tail prediction/target abs correlation | 0.0355503 | is None or <= 0.25 | yes |
| capital absolute delta | 0.00448143 | <= 0.05 | yes |
...
| Criterion | Value | Rule | Pass |
| --- | ---: | --- | --- |
| mean tail strict accuracy | 0.492333 | <= 0.56 | yes |
| high-accuracy seed fraction | 0 | <= 0.2 | yes |
| mean absolute tail prediction/target correlation | 0.0544375 | <= 0.2 | yes |
