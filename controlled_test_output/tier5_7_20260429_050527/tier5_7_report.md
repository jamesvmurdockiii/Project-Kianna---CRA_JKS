...
- Generated: `2026-04-29T09:08:17+00:00`
- Status: **PASS**
- Backend: `nest`
- Promoted setting: `readout_lr=0.1`, `delayed_readout_lr=0.2`
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier5_7_20260429_050527`
...
| --- | --- | ---: | ---: | --- | --- |
| `tier1_controls` | **PASS** | 0 | 17.840 | negative controls stay negative under the promoted learning setting | `/Users/james/JKS:CRA/controlled_test_output/tier5_7_20260429_050527/tier1_controls/tier1_results.json` |
| `tier2_learning` | **PASS** | 0 | 16.965 | positive learning controls still pass under the promoted setting | `/Users/james/JKS:CRA/controlled_test_output/tier5_7_20260429_050527/tier2_learning/tier2_results.json` |
| `tier3_ablations` | **PASS** | 0 | 125.547 | core mechanism ablation gaps remain meaningful under the promoted setting | `/Users/james/JKS:CRA/controlled_test_output/tier5_7_20260429_050527/tier3_ablations/tier3_results.json` |
| `target_task_smokes` | **PASS** | 0 | 9.585 | delayed_cue and hard_noisy_switching smoke matrix still executes with CRA locked | `/Users/james/JKS:CRA/controlled_test_output/tier5_7_20260429_050527/target_task_smokes/tier5_6_results.json` |
