...
- Generated: `2026-05-01T08:05:40+00:00`
- Mode: `local`
- Status: **PASS**
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier4_22t_20260501_native_keyed_route_state_smoke_local`
...
- next_step_if_passed: `Prepare cra_422ac and run the Tier 4.22t tiny native keyed route-state micro-task on EBRAINS.`
...
| reference final weight positive after native route stream | `32768` | `> 0` | yes |
...
| source native context and keyed-route command constants exist | `CMD_WRITE_CONTEXT/CMD_WRITE_ROUTE_SLOT/CMD_SCHEDULE_KEYED_ROUTE_CONTEXT_PENDING` | `custom runtime must expose native context plus keyed route-state primitives` | yes |
...
| source native keyed routed schedule forms feature on chip | `feature = FP_MUL(FP_MUL(context_value, route_value), cue)` | `host must send key+cue, while the runtime retrieves context+route slot by key and computes the scalar feature` | yes |
...
- `reference_json`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22t_20260501_native_keyed_route_state_smoke_local/tier4_22t_task_reference.json`
- `reference_csv`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22t_20260501_native_keyed_route_state_smoke_local/tier4_22t_task_reference_rows.csv`
- `manifest_json`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22t_20260501_native_keyed_route_state_smoke_local/tier4_22t_results.json`
- `report_md`: `/Users/james/JKS:CRA/controlled_test_output/tier4_22t_20260501_native_keyed_route_state_smoke_local/tier4_22t_report.md`
