...
- Generated: `2026-04-28T04:18:03+00:00`
- Status: **PASS**
- CRA backend: `mock`
- Seeds: `42`
- Run lengths: `120`
...
- Output directory: `/Users/james/Kimi_Agent_Spinnaker Neuromorphic Design/controlled_test_output/tier5_6_20260428_001803`
...
| --- | --- | --- | --- | --- |
| full tuned-baseline run matrix completed | 5 | == 5 | yes |  |
| all aggregate cells produced | 5 | == 5 | yes |  |
| all requested run lengths represented | [120] | == [120] | yes |  |
| all best-profile groups reported | 2 | == 2 | yes |  |
| all comparison rows produced | 1 | == 1 | yes |  |
...
| paired confidence intervals produced for comparisons | 1 | == 1 | yes |  |
