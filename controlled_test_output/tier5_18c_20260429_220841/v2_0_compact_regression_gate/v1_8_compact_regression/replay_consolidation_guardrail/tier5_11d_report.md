...
- Generated: `2026-04-29T22:09:08.164287+00:00`
- Status: **PASS**
- Backend: `mock`
- Steps: `180`
- Seeds: `42`
...
- Output directory: `/Users/james/JKS:CRA/controlled_test_output/tier5_18c_20260429_220841/v2_0_compact_regression_gate/v1_8_compact_regression/replay_consolidation_guardrail`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| silent_context_reentry | `key_label_permuted_replay` | replay_ablation | 0.333333 | 0 | 5 | 5 | 0 | 0.430172 |
| silent_context_reentry | `no_consolidation_replay` | replay_ablation | 1 | 1 | 5 | 0 | 0 | 0.42917 |
| silent_context_reentry | `oracle_context_scaffold` | external_scaffold | 1 | 1 | 0 | 0 | 0 | 0.423355 |
| silent_context_reentry | `prioritized_replay` | replay_candidate | 1 | 1 | 5 | 5 | 0 | 0.425117 |
| silent_context_reentry | `priority_only_ablation` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.431591 |
| silent_context_reentry | `random_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.423594 |
| silent_context_reentry | `shuffled_order_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.426279 |
| silent_context_reentry | `unbounded_keyed_control` | capacity_upper_bound | 1 | 1 | 0 | 0 | 0 | 0.425247 |
| silent_context_reentry | `v1_6_no_replay` | candidate_no_replay | 1 | 1 | 0 | 0 | 0 | 0.432115 |
| silent_context_reentry | `wrong_key_replay` | replay_ablation | 1 | 1 | 5 | 5 | 0 | 0.424299 |
| silent_context_reentry | `memory_reset` |  | 1 | 1 | None | None | None | 0.00073175 |
| silent_context_reentry | `online_perceptron` |  | 0.666667 | 1 | None | None | None | 0.00105446 |
| silent_context_reentry | `oracle_context` |  | 1 | 1 | None | None | None | 0.000650625 |
| silent_context_reentry | `shuffled_context` |  | 1 | 1 | None | None | None | 0.000711208 |
| silent_context_reentry | `sign_persistence` |  | 1 | 1 | None | None | None | 0.00102225 |
| silent_context_reentry | `stream_context_memory` |  | 1 | 1 | None | None | None | 0.000649334 |
| silent_context_reentry | `wrong_context` |  | 0 | 0 | None | None | None | 0.000674917 |
