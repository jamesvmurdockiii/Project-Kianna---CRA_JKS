...
- Mode: `ingest`
- Status: **PASS**
- Output directory: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested`
...
- `aplx_build_stderr`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_aplx_build_stderr (10).txt`
- `aplx_build_stdout`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_aplx_build_stdout (9).txt`
- `environment_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_environment.json`
- `host_test_stderr`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_host_test_stderr (9).txt`
- `host_test_stdout`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_host_test_stdout (9).txt`
- `learning_parity_result_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_learning_parity_result.json`
- `learning_parity_rows_csv`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_learning_parity_rows.csv`
- `load_result_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_load_result.json`
- `main_syntax_stderr`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_main_syntax_normal_stderr (8).txt`
- `main_syntax_stdout`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_main_syntax_normal_stdout (8).txt`
- `manifest_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_results.json`
- `reference_csv`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_parity_reference.csv`
- `reference_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_reference.json`
- `report_md`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_report.md`
- `target_acquisition_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_target_acquisition.json`
- `raw_remote_manifest_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/remote_tier4_22l_results_raw.json`
- `raw_remote_report_md`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/remote_tier4_22l_report_raw.md`
- `remote_latest_manifest_json`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22l_latest_manifest.json`
- `main_syntax_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/tier4_22i_main_syntax_normal (8).o`
- `aplx_binary`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/coral_reef (4).aplx`
- `elf_binary`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/coral_reef (5).elf`
- `elf_listing`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/coral_reef (4).txt`
- `spinnaker_reports_zip`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/reports (15).zip`
- `main_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/main (7).o`
- `host_interface_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/host_interface (6).o`
- `state_manager_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/state_manager (7).o`
- `synapse_manager_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/synapse_manager (7).o`
- `neuron_manager_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/neuron_manager (7).o`
- `router_object`: `<repo>/controlled_test_output/tier4_22l_20260501_custom_runtime_learning_parity_hardware_pass_ingested/router (5).o`
