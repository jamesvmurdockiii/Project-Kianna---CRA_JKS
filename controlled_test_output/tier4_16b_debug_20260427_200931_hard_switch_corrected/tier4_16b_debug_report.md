...
- max_hardware_tail_delta: `0.0952381`
...
| `local_chunked_vs_hardware` | `direct_chunked_host_replay` | `returned_hardware_chunked_host_replay` | 42 | `nest` | 0.0952381 | 0.984845 | 0.444256 |
...
| `local_chunked_vs_hardware` | `direct_chunked_host_replay` | `returned_hardware_chunked_host_replay` | 42 | `brian2` | 0.0952381 | 0.984845 | 0.87471 |
...
| `local_chunked_vs_hardware` | `direct_chunked_host_replay` | `returned_hardware_chunked_host_replay` | 43 | `nest` | 0.0714286 | 0.888714 | 0.454791 |
...
| `local_chunked_vs_hardware` | `direct_chunked_host_replay` | `returned_hardware_chunked_host_replay` | 43 | `brian2` | 0.0714286 | 0.888714 | 0.863443 |
...
| `local_chunked_vs_hardware` | `direct_chunked_host_replay` | `returned_hardware_chunked_host_replay` | 44 | `nest` | 0.047619 | 0.648987 | 0.446768 |
...
| `local_chunked_vs_hardware` | `direct_chunked_host_replay` | `returned_hardware_chunked_host_replay` | 44 | `brian2` | 0.047619 | 0.648987 | 0.871254 |

## Criteria

| Criterion | Value | Rule | Pass |
| --- | --- | --- | --- |
| corrected boolean parser applied | True | == True | yes |
