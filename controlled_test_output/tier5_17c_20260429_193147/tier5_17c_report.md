...
- expected_runs: `99`
- observed_runs: `99`
- candidate_min_ridge_probe_accuracy: `0.386667`
- candidate_min_knn_probe_accuracy: `0.174603`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| long_gap_temporal_continuation | 0.671751 | 0.422643 | 0.42106 | 0.436581 | 0.58139 | 0.438198 | 0.418888 | 0.578332 | 0.0903612 |
| masked_channel_context | 0.630464 | 0.323039 | 0.354312 | 0.660728 | 0.613888 | 0.381562 | 0.333077 | 0.728932 | -0.0984671 |
| same_visible_different_latent | 0.890045 | 0.491338 | 0.504692 | 0.824762 | 0.695782 | 0.506423 | 0.487016 | 0.767281 | 0.0652832 |
...
| candidate reaches minimum ridge-probe accuracy | 0.386667 | >= 0.74 | no |  |
| candidate reaches minimum kNN-probe accuracy | 0.174603 | >= 0.68 | no |  |
| candidate beats no-preexposure control | 0.249108 | >= 0.08 | yes |  |
| time-shuffled preexposure loses | 0.250691 | >= 0.05 | yes |  |
| target-shuffled preexposure loses | -0.030264 | >= 0.05 | no |  |
| wrong-domain preexposure loses | 0.0165759 | >= 0.05 | no |  |
| fixed-history baseline does not explain result | 0.233553 | >= 0.02 | yes |  |
| reservoir baseline does not explain result | 0.252863 | >= 0.02 | yes |  |
| STDP-only baseline does not explain result | -0.0984671 | >= 0.02 | no |  |
| candidate beats best non-oracle control | -0.0984671 | >= 0.01 | no |  |
| downstream sample-efficiency improves | 3 | >= 2 | yes |  |

Failure: Failed criteria: candidate reaches minimum ridge-probe accuracy, candidate reaches minimum kNN-probe accuracy, target-shuffled preexposure loses, wrong-domain preexposure loses, STDP-only baseline does not explain result, candidate beats best non-oracle control
