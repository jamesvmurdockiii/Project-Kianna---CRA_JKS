# CRA Evidence Baseline v0.9

- Frozen at: `2026-04-28T03:43:35.593907+00:00`
- Source registry generated at: `2026-04-28T03:42:18.277171+00:00`
- Registry status: **PASS**
- Canonical evidence bundles: `18`
- Core tests: `12`
- Expanded tracked evidence entries: `24`
- Missing expected artifacts: `0`
- Failed canonical criteria: `0`
- Noncanonical output folders recorded by registry: `53`

## Freeze Rule

Historical evidence lock after Tier 5.5 expanded software baseline matrix passed and before Tier 5.6 hyperparameter fairness audit.

## Strongest Current Claim

CRA has a controlled post-Tier-5.5 evidence baseline: negative controls, positive learning tests, mechanism ablations, software scaling/domain/backend evidence, minimal repeatable SpiNNaker fixed-pattern hardware evidence, learning-curve/failure-analysis/delayed-credit confirmation, repaired delayed-cue and hard-switch SpiNNaker transfer across seeds 42/43/44, v0.7 chunked-host hardware runtime characterization, and a 1,800-run expanded software baseline matrix showing robust advantage regimes and non-dominated hard/adaptive behavior while documenting where strong external baselines tie or win.

## Claim Boundaries

- Tier 5.5 supports controlled software expanded-baseline evidence only; it is not hardware evidence.
- Tier 5.5 is not a hyperparameter fairness audit. Tier 5.6 must retune/audit baselines before a strong comparative paper claim.
- CRA does not claim universal superiority: delayed_cue and sensor_control saturate or tie strong baselines, and hard_noisy_switching beats the external median at 1500 steps but trails the best external tail score there.
...
## Important Noncanonical Diagnostics Frozen With v0.9
...
- `CRA_EVIDENCE_BASELINE_v0.9.json`: machine-readable baseline record
- `CRA_EVIDENCE_BASELINE_v0.9_STUDY_REGISTRY.snapshot.json`: exact registry snapshot at freeze time

## Next Evidence After Freeze

- Tier 5.6 baseline hyperparameter fairness audit: retune/strengthen external baselines and add deferred reviewer-defense models where task-compatible.
- Tier 5.7 compact regression after any promoted tuning or mechanism change.
