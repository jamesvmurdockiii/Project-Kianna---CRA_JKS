# CRA Evidence Baseline v2.1

- Frozen at: `2026-04-29T22:37:39.318850+00:00`
- Source registry generated at: `2026-04-29T22:36:49.145921+00:00`
...
- Noncanonical output folders recorded by registry: `163`

## Freeze Rule

Historical evidence lock after Tier 5.18 self-evaluation diagnostic passed and Tier 5.18c compact promotion/regression gate reran the full v2.0 gate plus the self-evaluation guardrail successfully.

## Strongest Current Claim

CRA now has a bounded v2.1 host-side software self-evaluation / reliability-monitoring baseline: pre-feedback confidence estimates primary-path error and hazard/OOD/mismatch risk, and confidence-gated behavior improves adaptation over v2.0 no-monitor and strong confidence shams, while the v2.0 compact guardrail remains green.

## Claim Boundaries

- v2.1 is a host-side software evidence baseline for operational self-evaluation / reliability monitoring layered on v2.0 predictive-binding evidence.
- It does not prove consciousness, self-awareness, human-style introspection, SpiNNaker/custom-C/on-chip self-monitoring, language, long-horizon planning, AGI, or external-baseline superiority.
- Tier 5.18c is a promotion/regression gate, not a new capability claim by itself.
- Tier 5.18 and Tier 5.18c do not change the canonical hardware claims or the external-baseline superiority boundary.
- Future policy/action and long-horizon planning work should branch from v2.1 only with its own leakage-safe shams and compact regression before any further freeze.
...
## Tier 5.18 Self-Evaluation Guardrail Summary

- Expected / observed runs: `150` / `150`
- Outcome leakage runs: `0`
- Pre-feedback monitor failures: `0`
- Candidate min primary-error AUROC: `0.9866370896184561`
- Candidate min hazard/OOD/mismatch AUROC: `0.9990547798066595`
- Candidate max Brier score: `0.06043047815681541`
- Candidate max ECE: `0.15280317572237959`
- Candidate min bad-action avoidance under detected risk: `0.7634342502945546`
- Minimum accuracy edge versus v2.0: `0.25324074074074077`
- Minimum accuracy edge versus best non-oracle control: `0.250462962962963`
