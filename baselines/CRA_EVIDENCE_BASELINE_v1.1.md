# CRA Evidence Baseline v1.1

- Frozen at: `2026-04-28T05:06:09.860165+00:00`
- Source registry generated at: `2026-04-28T05:05:50.648002+00:00`
- Registry status: **PASS**
- Canonical evidence bundles: `20`
- Core tests: `12`
- Expanded tracked evidence entries: `24`
- Missing expected artifacts: `0`
- Failed canonical criteria: `0`
- Noncanonical output folders recorded by registry: `56`

## Freeze Rule

Historical evidence lock after Tier 5.7 compact regression passed and before Tier 6 lifecycle/self-scaling experiments.

## Strongest Current Claim

CRA has a controlled post-Tier-5.7 evidence baseline: all prior v1.0 evidence plus a compact regression proving the promoted delayed-credit setting still passes negative controls, positive learning controls, architecture ablations, and delayed_cue/hard_noisy_switching smoke checks. The strongest honest comparative claim remains that CRA is robust/non-dominated in target hard/adaptive regimes after reasonable external-baseline retuning; Tier 5.7 adds guardrail confidence, not a new superiority claim.

## Claim Boundaries

- Tier 5.7 is controlled software regression evidence only; it is not hardware evidence.
- Tier 5.7 proves the promoted v1.0 setting did not break compact controls/learning/ablation/task-smoke gates; it does not prove new capability.
- CRA still does not claim universal superiority: hard_noisy_switching survives retuning but trails the best tuned perceptron tail score at 1500 steps.
- Lifecycle/self-scaling value, sham controls, circuit motif causality, compositional reuse, predictive/world-model behavior, working memory, temporal-code robustness, unsupervised representation learning, and native eligibility remain future claims.
- Tier 4.16a/4.16b/4.18a remain narrow chunked-host hardware-transfer/runtime results, not full hardware scaling or on-chip learning.
...
## Important Noncanonical Diagnostics Frozen With v1.1
...
- `CRA_EVIDENCE_BASELINE_v1.1.json`: machine-readable baseline record
- `CRA_EVIDENCE_BASELINE_v1.1_STUDY_REGISTRY.snapshot.json`: exact registry snapshot at freeze time

## Next Evidence After Freeze

- Tier 6.1 software lifecycle/self-scaling benchmark with fixed-N controls.
- Tier 6.3 lifecycle sham controls to prove any lifecycle advantage is not artifact-driven.
...
- Tier 4.19 hardware lifecycle/self-scaling feasibility only after software lifecycle value survives controls.
