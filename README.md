...
| Active next gate | Tier 7.1c compact C-MAPSS FD001 scoring gate: score v2.2, v2.3, and fair baselines on the same leakage-safe rows before making any public usefulness claim. |
| Canonical registry | 90 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
