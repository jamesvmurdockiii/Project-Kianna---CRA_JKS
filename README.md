...
| Active next gate | Tier 7.7n partitioned-driver attribution scoring gate: score the locked 7.7m variants and driver-group ablations before any promotion, freeze, native transfer, or architecture change. |
| Canonical registry | 136 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
