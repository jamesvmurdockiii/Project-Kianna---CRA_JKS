...
| Active next gate | Tier 7.7a v2.5 standardized benchmark/usefulness scoreboard contract: lock the public/standardized scoreboard and baselines before scoring v2.5. |
| Canonical registry | 123 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
