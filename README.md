...
| Active next gate | Tier 7.6e planning/subgoal-control promotion + compact regression gate: decide whether the reduced-feature planning mechanism can be promoted into the software baseline line after compact regression and shams. |
| Canonical registry | 122 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
