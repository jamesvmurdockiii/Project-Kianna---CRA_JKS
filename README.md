...
| Active next gate | Tier 7.6d reduced-feature planning generalization / task repair: rerun planning pressure with reduced feature access, held-out composition variants, and stricter route/key attribution before any promotion/regression reopens. |
| Canonical registry | 121 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
