...
| Active next gate | Tier 7.7k effective-state-dimensionality repair contract: pre-register a repair to increase independent recurrent state dimensions under Lorenz/NARMA pressure without changing the public benchmark scoreboard post hoc. |
| Canonical registry | 133 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
