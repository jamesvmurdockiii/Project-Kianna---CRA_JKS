...
| Active next gate | Tier 4.32b static reef partition smoke/resource mapping: map groups/modules/polyps to cores using the measured single-chip replicated-shard envelope. Multi-chip work and native-scale baseline freeze remain blocked until static partition evidence passes. |
