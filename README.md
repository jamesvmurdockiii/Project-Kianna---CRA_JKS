...
| Active next gate | Tier 7.7i capacity sham-separation / state-specificity contract: determine whether the 7.7h capacity gains are candidate-specific state geometry or generic high-dimensional/permuted recurrent features before adding mechanisms or tuning. |
| Canonical registry | 131 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
