...
[![Evidence](https://img.shields.io/badge/canonical%20evidence-102%20bundles-blue.svg)](STUDY_EVIDENCE_INDEX.md)
...
| Active next gate | Tier 7.1j NAB failure/localization analysis: explain why simple rolling z-score beats v2.3 broadly, while v2.3 still wins localized stream families and beats v2.2/shams. |
| Canonical registry | 102 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
...
@software{cra_2026,
  ...
  note         = {102 canonical evidence bundles; bounded SpiNNaker hardware validation}
}
```
