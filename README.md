...
| Active next gate | Tier 7.7m partitioned-driver attribution contract: pre-register whether the 7.7l gain comes from causal driver partitioning, nonlinear/lag features, readout/interface effects, or another confound before any promotion or architecture change. |
| Canonical registry | 135 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
