...
| Active next gate | Tier 7.0f benchmark-protocol repair and failure localization. Tier 7.0e short/medium calibration passed but did not make v2.2 competitive with ESN; the 10k standardized sweep is blocked by a non-finite NARMA10 seed-44 stream and must not be treated as model evidence until the finite-stream policy is repaired. |
