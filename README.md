...
| Latest 4.32e package | Tier 4.32e multi-chip learning micro-task prepared at [`controlled_test_output/tier4_32e_20260507_prepared`](controlled_test_output/tier4_32e_20260507_prepared): upload folder `ebrains_jobs/cra_432e`, command `cra_432e/experiments/tier4_32e_multichip_learning_microtask.py --mode run-hardware --output-dir tier4_32e_job_output`, 32 events per case, enabled-learning reference readout `32768/0`, no-learning control reference `0/0`, and no hardware claim until EBRAINS artifacts are ingested. |
| Active next gate | Run Tier 4.32e on EBRAINS and ingest the returned artifacts before claiming multi-chip learning transfer, speedup, benchmarks, true two-partition learning, lifecycle scaling, or any native-scale baseline freeze. |
