...
| Active next gate | Tier 7.8 polyp morphology/template variability contract: test whether varying polyp internal templates, timescales, and excitatory/inhibitory ratios can increase population-level state diversity without smuggling in generic random projection as the explanation. |
