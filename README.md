...
| Latest standardized benchmark contract | Tier 7.7a passed from [`controlled_test_output/tier7_7a_20260509_v2_5_standardized_scoreboard_contract`](controlled_test_output/tier7_7a_20260509_v2_5_standardized_scoreboard_contract): outcome `v2_5_standardized_scoreboard_contract_locked`; `20/20` criteria passed. The primary scoreboard is locked as Mackey-Glass, Lorenz, and NARMA10 at 8000 steps, horizon 8, seeds 42/43/44, chronological 65/35 split. C-MAPSS FD001 and NAB are secondary public/real-ish confirmation tracks only. No scoring, public usefulness claim, freeze, or hardware/native transfer yet. |
...
| Active next gate | Tier 7.7b v2.5 standardized benchmark/usefulness scoreboard scoring gate: score frozen v2.5 on the locked 7.7a public/standardized scoreboard without changing tasks, splits, baselines, shams, or pass/fail rules. |
| Canonical registry | 124 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
...
- Evidence registry generation: 124 canonical bundles, 0 failed criteria.
...
@software{cra_2026,
  ...
  note         = {124 canonical evidence bundles; bounded SpiNNaker hardware validation}
}
```
