...
| Active next gate | Tier 4.32d two-chip split-role single-shard MCPL lookup hardware smoke: package/run the smallest cross-chip communication and readback target; no learning-scale, speedup, benchmark, true two-partition, or baseline-freeze claim. |
