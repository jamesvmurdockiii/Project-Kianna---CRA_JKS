...
| Active next gate | Tier 7.1e C-MAPSS capped-RUL/readout fairness confirmation: test whether the v2.2 capped-ridge signal is statistically meaningful or just noise before any usefulness claim, mechanism change, or native transfer. |
| Canonical registry | 92 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
