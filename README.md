...
| Active next gate | Tier 7.7o generic temporal-interface reframing contract: decide whether random projection / nonlinear-lag gains become external baselines, an optional adapter, or a new CRA-internal mechanism candidate with strict shams. |
| Canonical registry | 137 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
