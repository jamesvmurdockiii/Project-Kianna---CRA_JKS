...
| Active next gate | Tier 4.32c inter-chip feasibility contract: define board/chip/shard key fields, message paths, compact readback ownership, failure counters, and the smallest cross-chip smoke target before any multi-chip hardware job. |
