...
| Active next gate | Tier 7.7h Lorenz capacity / NARMA memory-depth scoring gate: run the locked 7.7g capacity matrix and classify the remaining gap as capacity-limited, capacity-helpful-but-baseline-limited, architecture-limited-flat, overfit/sham-blocked, or Mackey-regressing. |
| Canonical registry | 130 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
