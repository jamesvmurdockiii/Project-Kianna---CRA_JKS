...
[![Evidence](https://img.shields.io/badge/canonical%20evidence-87%20bundles-blue.svg)](STUDY_EVIDENCE_INDEX.md)
...
| Active next gate | Tier 6.2a / 7.1 targeted usefulness validation: use v2.3 as the frozen software baseline, test hard/real-ish tasks with fair baselines, and do not move v2.3 native/on-chip until a separate transfer contract is justified. |
| Canonical registry | 87 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
