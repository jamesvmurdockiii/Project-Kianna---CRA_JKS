...
| Active next gate | Tier 7.1f next public adapter contract / family selection: stop tuning C-MAPSS for now and select the next predeclared public benchmark family with fixed sources, baselines, leakage rules, and pass/fail criteria. |
| Canonical registry | 93 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
