...
| Latest prepared EBRAINS package | None pending after Tier 4.30e ingest; next package should be prepared only after the Tier 4.30f contract is checked. |
| Active next gate | Tier 4.30f lifecycle sham-control hardware subset design/prepare, kept small and reviewer-defensible. |
