...
| Active next gate | Tier 4.32d first two-chip split-role single-shard MCPL lookup smoke package: run only the contract-defined cross-chip communication/readback smoke after route/source/package QA; no learning-scale, speedup, benchmark, or baseline-freeze claim. |
