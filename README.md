...
| Active next gate | Tier 7.6c long-horizon planning / subgoal-control attribution + promotion decision: reconcile the 7.6b scaffold signal, test feature/route/key attribution and leakage, and decide whether a compact promotion/regression gate is justified. |
| Canonical registry | 120 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
