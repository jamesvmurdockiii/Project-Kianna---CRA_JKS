...
[![Evidence](https://img.shields.io/badge/canonical%20evidence-103%20bundles-blue.svg)](STUDY_EVIDENCE_INDEX.md)
...
| Active next gate | Tier 7.1k NAB adapter/readout false-positive repair: reduce v2.3 false positives under a predeclared no-label policy, then rerun against rolling z-score and shams. |
| Canonical registry | 103 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
...
@software{cra_2026,
  ...
  note         = {103 canonical evidence bundles; bounded SpiNNaker hardware validation}
}
```
