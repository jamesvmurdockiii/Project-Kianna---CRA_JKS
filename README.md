...
| Active next gate | Tier 7.7j capacity sham-separation / state-specificity scoring gate: score the locked 7.7i state-geometry probes and classify whether capacity gains are candidate-specific, generic-basis explained, low-rank collapsed, readout-limited, observability-limited, or inconclusive. |
| Canonical registry | 132 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
