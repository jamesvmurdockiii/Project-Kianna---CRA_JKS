...
| Active next gate | Tier 7.7g Lorenz state-capacity / NARMA memory-depth diagnostic contract: determine whether the remaining standardized gap is capacity/state-interface limited or structurally architectural before adding more mechanisms. |
| Canonical registry | 129 evidence bundles, 0 missing expected artifacts, 0 failed criteria. |
