...
| Latest single-chip scale preflight | Tier 4.32a passed `18/18` from [`controlled_test_output/tier4_32a_20260506_single_chip_scale_stress`](controlled_test_output/tier4_32a_20260506_single_chip_scale_stress): the 4/5/8/12/16-core MCPL-first stress envelope is predeclared, schedule/slot/pending/readback/profile gates are bounded, Tier 4.32a-hw is authorized next, and 4.32b/multi-chip/native-scale baseline freeze remain blocked. |
...
| Active next gate | Tier 4.32a-hw EBRAINS single-chip multi-core scale stress using the 4.32a preflight: run the predeclared 4/5/8/12/16-core MCPL-first points, return compact per-core readback/profile artifacts, and measure stale/duplicate/timeout/drop counters before static reef partitioning or multi-chip work. |
