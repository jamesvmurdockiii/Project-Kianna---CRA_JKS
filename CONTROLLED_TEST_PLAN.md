...
are not canonical paper-table evidence unless they are explicitly registered in
`experiments/evidence_registry.py` and regenerated by `make validate`, or frozen
by a clean promotion gate.
