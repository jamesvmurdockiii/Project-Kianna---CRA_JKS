...
the tracked evidence suite is now generated by the registry and currently contains **111 entries total**. The generated registry is
...
verifying source/split/cost/schema readiness before scoring. The current active
step is Tier 7.4f cost-aware policy/action held-out scoring gate.
