...
the tracked evidence suite is now generated by the registry and currently contains **110 entries total**. The generated registry is
...
scoring. The current active step is Tier 7.4e cost-aware policy/action held-out
scoring preflight.
