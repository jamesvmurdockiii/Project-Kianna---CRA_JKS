...
This is single-chip replicated-shard hardware evidence only. Static reef
partition smoke/resource mapping is now active; multi-chip work and native-scale
baseline freeze remain blocked until that evidence passes.
