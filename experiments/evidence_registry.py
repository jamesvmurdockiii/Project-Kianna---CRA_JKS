...
SPECS: tuple[EvidenceSpec, ...] = (
    ...
    EvidenceSpec(
        entry_id="tier7_1i_nab_fairness_confirmation",
        tier_label="Tier 7.1i - NAB Fairness/Statistical Confirmation",
        plan_position="Phase H software usefulness: broader NAB confirmation/localization after Tier 7.1h",
        canonical_dir="tier7_1i_20260508_nab_fairness_confirmation",
        results_file="tier7_1i_results.json",
        report_file="tier7_1i_report.md",
        summary_file="tier7_1i_summary.csv",
        harness="experiments/tier7_1i_nab_fairness_confirmation.py",
        evidence_role="broader public anomaly confirmation / failure localization",
        claim="Tier 7.1i broadened the pinned NAB software scoring subset to 20 streams across 6 categories. v2.3 beat v2.2 and shams, but the broader signal was localized rather than statistically confirmed: rolling z-score was best overall and v2.3 ranked fourth.",
        caveat="Broader NAB software confirmation/localization only; not a full NAB benchmark claim by itself, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_1i_latest_manifest.json",),
        expected_extra_files=(
            "tier7_1i_model_metrics.csv",
            "tier7_1i_model_summary.csv",
            "tier7_1i_category_summary.csv",
            "tier7_1i_stream_summary.csv",
            "tier7_1i_thresholds.csv",
            "tier7_1i_score_preview.csv",
            "tier7_1i_bootstrap.csv",
            "tier7_1i_source_manifest.csv",
            "tier7_1i_scoring_contract.json",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_1j_nab_failure_localization",
        tier_label="Tier 7.1j - NAB Failure/Localization Analysis",
        plan_position="Phase H software usefulness: NAB failure localization after Tier 7.1i",
        canonical_dir="tier7_1j_20260508_nab_failure_localization",
        results_file="tier7_1j_results.json",
        report_file="tier7_1j_report.md",
        summary_file="tier7_1j_summary.csv",
        harness="experiments/tier7_1j_nab_failure_localization.py",
        evidence_role="public anomaly failure localization / adapter-readout diagnosis",
        claim="Tier 7.1j localized the broader NAB gap: v2.3 has better event-F1/window recall than rolling z-score but loses on false-positive/NAB-style pressure; the result is threshold/false-positive-policy sensitive rather than a confirmed public usefulness win.",
        caveat="Software failure analysis only; not public usefulness proof, not a promoted mechanism, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_1j_latest_manifest.json",),
        expected_extra_files=(
            "tier7_1j_policy_metrics.csv",
            "tier7_1j_policy_summary.csv",
            "tier7_1j_category_summary.csv",
            "tier7_1j_stream_summary.csv",
            "tier7_1j_thresholds.csv",
            "tier7_1j_diagnosis.csv",
            "tier7_1j_failure_analysis_contract.json",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_1k_nab_false_positive_repair",
        tier_label="Tier 7.1k - NAB Adapter/Readout False-Positive Repair",
        plan_position="Phase H software usefulness: NAB false-positive repair after Tier 7.1j",
        canonical_dir="tier7_1k_20260508_nab_false_positive_repair",
        results_file="tier7_1k_results.json",
        report_file="tier7_1k_report.md",
        summary_file="tier7_1k_summary.csv",
        harness="experiments/tier7_1k_nab_false_positive_repair.py",
        evidence_role="public anomaly adapter/readout false-positive repair candidate",
        claim="Tier 7.1k found a same-subset NAB false-positive repair candidate: a locked no-label persist3 alarm policy made v2.3 rank first on the broad NAB diagnostic subset, beat rolling z-score and v2.2 under that policy, separated all three v2.3 shams, and reduced false positives per 1000 from 16.5374 to 2.5685.",
        caveat="Software repair-candidate evidence only; policy was selected on the same broad diagnostic subset, window recall dropped versus raw v2.3, and this is not public usefulness proof, not a promoted mechanism, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_1k_latest_manifest.json",),
        expected_extra_files=(
            "tier7_1k_policy_metrics.csv",
            "tier7_1k_policy_summary.csv",
            "tier7_1k_category_summary.csv",
            "tier7_1k_stream_summary.csv",
            "tier7_1k_thresholds.csv",
            "tier7_1k_classification.csv",
            "tier7_1k_repair_contract.json",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_1l_nab_locked_policy_holdout_confirmation",
        tier_label="Tier 7.1l - NAB Locked-Policy Holdout Confirmation",
        plan_position="Phase H software usefulness: locked NAB policy holdout after Tier 7.1k",
        canonical_dir="tier7_1l_20260508_nab_locked_policy_holdout_confirmation",
        results_file="tier7_1l_results.json",
        report_file="tier7_1l_report.md",
        summary_file="tier7_1l_summary.csv",
        harness="experiments/tier7_1l_nab_locked_policy_holdout_confirmation.py",
        evidence_role="public anomaly locked-policy holdout confirmation / claim narrowing",
        claim="Tier 7.1l locked the Tier 7.1k persist3 false-positive repair and tested it on 12 held-out NAB streams across 6 categories. The policy reduced v2.3 false positives versus raw v2.3, but did not confirm public usefulness: v2.3 ranked fifth under the locked policy, did not beat rolling z-score or v2.2, and separated only two of three shams.",
        caveat="Software holdout confirmation only; this narrows the NAB claim and blocks any public usefulness proof, baseline freeze, hardware/native transfer, or AGI/ASI claim from the 7.1k same-subset repair.",
        latest_manifest_names=("tier7_1l_latest_manifest.json",),
        expected_extra_files=(
            "tier7_1l_policy_metrics.csv",
            "tier7_1l_policy_summary.csv",
            "tier7_1l_category_summary.csv",
            "tier7_1l_stream_summary.csv",
            "tier7_1l_thresholds.csv",
            "tier7_1l_classification.csv",
            "tier7_1l_holdout_contract.json",
            "tier7_1l_source_manifest.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_1m_nab_closeout_mechanism_return_decision",
        tier_label="Tier 7.1m - NAB Closeout / Mechanism-Return Decision",
        plan_position="Phase H software usefulness: NAB claim narrowing after Tier 7.1l",
        canonical_dir="tier7_1m_20260508_nab_closeout_mechanism_return_decision",
        results_file="tier7_1m_results.json",
        report_file="tier7_1m_report.md",
        summary_file="tier7_1m_summary.csv",
        harness="experiments/tier7_1m_nab_closeout_mechanism_return_decision.py",
        evidence_role="public anomaly evidence synthesis / next-mechanism decision",
        claim="Tier 7.1m closed the NAB adapter-policy loop: Tier 7.1h-7.1l show partial/local NAB signal and a same-subset false-positive repair candidate, but no held-out public usefulness confirmation. The gate narrows the NAB claim, stops adapter-policy tuning, and routes the next work to general cost-aware policy/action selection.",
        caveat="Evidence synthesis and decision gate only; not a new benchmark score, not public usefulness proof, not a promoted mechanism, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_1m_latest_manifest.json",),
        expected_extra_files=(
            "tier7_1m_decision.json",
            "tier7_1m_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4a_cost_aware_policy_action_contract",
        tier_label="Tier 7.4a - Cost-Aware Policy/Action Selection Contract",
        plan_position="Phase H general mechanism: policy/action contract after NAB closeout",
        canonical_dir="tier7_4a_20260509_cost_aware_policy_action_contract",
        results_file="tier7_4a_results.json",
        report_file="tier7_4a_report.md",
        summary_file="tier7_4a_summary.csv",
        harness="experiments/tier7_4a_cost_aware_policy_action_contract.py",
        evidence_role="policy/action mechanism contract",
        claim="Tier 7.4a predeclared a general cost-aware policy/action selection mechanism gate after the NAB closeout. It defines asymmetric action costs, abstain/act/wait decisions, delayed consequences, external baselines, shams, ablations, metrics, pass/fail criteria, and compact-regression requirements before implementation.",
        caveat="Contract-only evidence; not a scoring run, not a promoted mechanism, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4a_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4a_contract.json",
            "tier7_4a_contract.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4b_cost_aware_policy_action_local_diagnostic",
        tier_label="Tier 7.4b - Cost-Aware Policy/Action Local Diagnostic",
        plan_position="Phase H general mechanism: local policy/action diagnostic after Tier 7.4a",
        canonical_dir="tier7_4b_20260509_cost_aware_policy_action_local_diagnostic",
        results_file="tier7_4b_results.json",
        report_file="tier7_4b_report.md",
        summary_file="tier7_4b_summary.csv",
        harness="experiments/tier7_4b_cost_aware_policy_action_local_diagnostic.py",
        evidence_role="policy/action mechanism local diagnostic",
        claim="Tier 7.4b implemented the local cost-aware policy/action diagnostic from the Tier 7.4a contract. Across three task families and seeds 42/43/44, the v2.3 cost-aware policy ranked first among non-oracle models, beat fixed/trivial/online external baselines by expected utility, separated shams and ablations, and avoided no-action collapse.",
        caveat="Local software diagnostic only; candidate mechanism evidence, not a promoted mechanism, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. The next gate is compact promotion/regression before any freeze.",
        latest_manifest_names=("tier7_4b_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4b_policy_metrics.csv",
            "tier7_4b_model_summary.csv",
            "tier7_4b_task_summary.csv",
            "tier7_4b_task_model_summary.csv",
            "tier7_4b_decision.json",
            "tier7_4b_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4c_cost_aware_policy_action_promotion_gate",
        tier_label="Tier 7.4c - Cost-Aware Policy/Action Promotion + Compact Regression",
        plan_position="Phase H general mechanism: policy/action promotion gate after Tier 7.4b",
        canonical_dir="tier7_4c_20260509_cost_aware_policy_action_promotion_gate",
        results_file="tier7_4c_results.json",
        report_file="tier7_4c_report.md",
        summary_file="tier7_4c_summary.csv",
        harness="experiments/tier7_4c_cost_aware_policy_action_promotion_gate.py",
        evidence_role="policy/action mechanism promotion and compact regression",
        claim="Tier 7.4c locked the Tier 7.4b cost-aware policy/action candidate and passed the full NEST compact regression gate. The candidate preserved its expected-utility advantage, sham/ablation separation, no-action guard, and leakage boundary, authorizing a v2.4 software baseline freeze while keeping hardware/native transfer blocked.",
        caveat="Software promotion/regression evidence only; not public usefulness proof, not broad anomaly benchmark superiority, not hardware/native transfer, not planning, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4c_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4c_promotion.json",
            "tier7_4c_promotion.csv",
            "tier7_4c_compact_child.json",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4d_cost_aware_policy_action_heldout_contract",
        tier_label="Tier 7.4d - Cost-Aware Policy/Action Held-Out/Public Usefulness Contract",
        plan_position="Phase H public usefulness: held-out action-cost contract after v2.4 freeze",
        canonical_dir="tier7_4d_20260509_cost_aware_policy_action_heldout_contract",
        results_file="tier7_4d_results.json",
        report_file="tier7_4d_report.md",
        summary_file="tier7_4d_summary.csv",
        harness="experiments/tier7_4d_cost_aware_policy_action_heldout_contract.py",
        evidence_role="held-out/public policy-action usefulness contract",
        claim="Tier 7.4d predeclared the held-out/public usefulness scoring contract for the frozen v2.4 cost-aware policy/action baseline. It locks public/real-ish action-cost families, actions, costs, splits, baselines, shams, statistics, pass/fail criteria, and artifacts before any v2.4 held-out scoring.",
        caveat="Contract-only evidence; not a scoring run, not public usefulness proof, not broad anomaly or predictive-maintenance superiority, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4d_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4d_contract.json",
            "tier7_4d_task_families.csv",
            "tier7_4d_baselines.csv",
            "tier7_4d_shams_ablations.csv",
            "tier7_4d_cost_model.csv",
            "tier7_4d_decision.json",
            "tier7_4d_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4e_cost_aware_policy_action_heldout_preflight",
        tier_label="Tier 7.4e - Cost-Aware Policy/Action Held-Out Scoring Preflight",
        plan_position="Phase H public usefulness: held-out action-cost scoring preflight after Tier 7.4d",
        canonical_dir="tier7_4e_20260509_cost_aware_policy_action_heldout_preflight",
        results_file="tier7_4e_results.json",
        report_file="tier7_4e_report.md",
        summary_file="tier7_4e_summary.csv",
        harness="experiments/tier7_4e_cost_aware_policy_action_heldout_preflight.py",
        evidence_role="held-out/public policy-action scoring preflight",
        claim="Tier 7.4e materialized the locked Tier 7.4d held-out scoring preflight for v2.4. It verifies NAB and C-MAPSS source/preflight artifacts, disjoint held-out splits, fixed costs, online/offline label separation, baseline and sham inventories, scoring schemas, and next-gate artifacts before any performance scoring.",
        caveat="Preflight/schema evidence only; not a scoring run, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4e_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4e_source_artifacts.csv",
            "tier7_4e_split_manifest.json",
            "tier7_4e_split_manifest.csv",
            "tier7_4e_cost_model.json",
            "tier7_4e_cost_model.csv",
            "tier7_4e_baseline_inventory.csv",
            "tier7_4e_sham_inventory.csv",
            "tier7_4e_scoring_schema.json",
            "tier7_4e_decision.json",
            "tier7_4e_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4f_cost_aware_policy_action_heldout_scoring_gate",
        tier_label="Tier 7.4f - Cost-Aware Policy/Action Held-Out Scoring Gate",
        plan_position="Phase H public usefulness: held-out action-cost scoring gate after Tier 7.4e",
        canonical_dir="tier7_4f_20260509_cost_aware_policy_action_heldout_scoring_gate",
        results_file="tier7_4f_results.json",
        report_file="tier7_4f_report.md",
        summary_file="tier7_4f_summary.csv",
        harness="experiments/tier7_4f_cost_aware_policy_action_heldout_scoring_gate.py",
        evidence_role="held-out/public policy-action scoring gate",
        claim="Tier 7.4f scored the frozen v2.4 cost-aware policy/action stack on the locked NAB and C-MAPSS public/real-ish action-cost families. The outcome is qualified C-MAPSS-only: v2.4 ranked first on C-MAPSS maintenance utility and beat the strongest external baseline with a positive paired CI, but NAB did not confirm and C-MAPSS did not separate from the prior v2.2 CRA reference with a positive paired CI.",
        caveat="Software held-out scoring only; qualified public-action signal, not broad public usefulness, not incremental v2.4 superiority over prior CRA references, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4f_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4f_score_rows.csv",
            "tier7_4f_model_summary.csv",
            "tier7_4f_family_decisions.csv",
            "tier7_4f_statistical_support.csv",
            "tier7_4f_action_rows_sample.csv",
            "tier7_4f_cmapss_selected_channels.csv",
            "tier7_4f_decision.json",
            "tier7_4f_decision.csv",
            "tier7_4f_cost_model.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4g_policy_action_confirmation_reference_separation",
        tier_label="Tier 7.4g - Held-Out Policy/Action Confirmation + Reference Separation",
        plan_position="Phase H public usefulness: confirmation/reference-separation gate after Tier 7.4f",
        canonical_dir="tier7_4g_20260509_policy_action_confirmation_reference_separation",
        results_file="tier7_4g_results.json",
        report_file="tier7_4g_report.md",
        summary_file="tier7_4g_summary.csv",
        harness="experiments/tier7_4g_policy_action_confirmation_reference_separation.py",
        evidence_role="held-out/public policy-action confirmation and failure analysis",
        claim="Tier 7.4g confirms the narrow C-MAPSS external/sham action-cost signal from Tier 7.4f while preserving the critical boundary that v2.4 does not separate from the prior v2.2 CRA reference with a positive paired CI. NAB remains a non-confirmation and is classified as an event-coverage gap rather than a held-out scoring bug.",
        caveat="Software held-out confirmation only; narrow C-MAPSS action-cost signal, not broad public usefulness, not incremental v2.4 superiority over v2.2, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4g_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4g_confirmation_checks.csv",
            "tier7_4g_reference_separation.csv",
            "tier7_4g_partition_checks.csv",
            "tier7_4g_nab_failure_analysis.csv",
            "tier7_4g_nab_category_analysis.csv",
            "tier7_4g_decision.json",
            "tier7_4g_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_4h_policy_action_attribution_closeout",
        tier_label="Tier 7.4h - Policy/Action Attribution Closeout / Mechanism Return Decision",
        plan_position="Phase H public usefulness: attribution closeout after Tier 7.4g",
        canonical_dir="tier7_4h_20260509_policy_action_attribution_closeout",
        results_file="tier7_4h_results.json",
        report_file="tier7_4h_report.md",
        summary_file="tier7_4h_summary.csv",
        harness="experiments/tier7_4h_policy_action_attribution_closeout.py",
        evidence_role="policy/action attribution closeout",
        claim="Tier 7.4h closes the held-out policy/action chain by preserving only the narrow C-MAPSS action-cost claim, blocking broad public usefulness, blocking incremental v2.4-over-v2.2 claims, blocking freeze/hardware transfer, and routing the project back to the general mechanism/benchmark roadmap.",
        caveat="Decision/attribution evidence only; not a new scoring run, not a mechanism promotion, not broad public usefulness, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_4h_latest_manifest.json",),
        expected_extra_files=(
            "tier7_4h_decision.json",
            "tier7_4h_decision.csv",
            "tier7_4h_claim_boundary.csv",
            "tier7_4h_route_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_5a_curriculum_environment_contract",
        tier_label="Tier 7.5a - Curriculum / Environment Generator Contract",
        plan_position="Phase H generality: curriculum/environment-generator contract after Tier 7.4h",
        canonical_dir="tier7_5a_20260509_curriculum_environment_contract",
        results_file="tier7_5a_results.json",
        report_file="tier7_5a_report.md",
        summary_file="tier7_5a_summary.csv",
        harness="experiments/tier7_5a_curriculum_environment_contract.py",
        evidence_role="curriculum/environment-generator contract",
        claim="Tier 7.5a locks the curriculum/environment-generator evidence contract before implementation: generated task families, difficulty schedule, hidden holdout splits, baselines, leakage guards, metrics, pass/fail gates, and future artifacts are predeclared.",
        caveat="Contract evidence only; not curriculum implementation, not scoring, not a mechanism promotion, not broad public usefulness, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_5a_latest_manifest.json",),
        expected_extra_files=(
            "tier7_5a_task_families.csv",
            "tier7_5a_difficulty_schedule.csv",
            "tier7_5a_split_contract.csv",
            "tier7_5a_baseline_inventory.csv",
            "tier7_5a_leakage_guards.csv",
            "tier7_5a_metrics.csv",
            "tier7_5a_pass_fail_gates.csv",
            "tier7_5a_expected_artifacts.csv",
            "tier7_5a_decision.json",
            "tier7_5a_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_5b_curriculum_environment_preflight",
        tier_label="Tier 7.5b - Curriculum / Environment Generator Implementation Preflight",
        plan_position="Phase H generality: curriculum/environment-generator implementation preflight after Tier 7.5a",
        canonical_dir="tier7_5b_20260509_curriculum_environment_preflight",
        results_file="tier7_5b_results.json",
        report_file="tier7_5b_report.md",
        summary_file="tier7_5b_summary.csv",
        harness="experiments/tier7_5b_curriculum_environment_preflight.py",
        evidence_role="curriculum/environment-generator implementation preflight",
        claim="Tier 7.5b materializes deterministic generated task-family streams, split manifests, hidden-label hashes, schema contracts, baseline compatibility rows, and leakage checks under the Tier 7.5a contract without scoring CRA or exposing hidden holdout labels.",
        caveat="Implementation preflight only; not generated-task scoring, not a mechanism promotion, not broad public usefulness, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_5b_latest_manifest.json",),
        expected_extra_files=(
            "tier7_5b_generator_manifest.json",
            "tier7_5b_split_manifest.csv",
            "tier7_5b_task_family_streams.csv",
            "tier7_5b_hidden_label_hashes.csv",
            "tier7_5b_schema_contract.csv",
            "tier7_5b_baseline_compatibility.csv",
            "tier7_5b_leakage_checks.csv",
            "tier7_5b_decision.json",
            "tier7_5b_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_5c_curriculum_environment_scoring_gate",
        tier_label="Tier 7.5c - Curriculum / Environment Generator Scoring Gate",
        plan_position="Phase H generality: generated-family scoring after Tier 7.5b preflight",
        canonical_dir="tier7_5c_20260509_curriculum_environment_scoring_gate",
        results_file="tier7_5c_results.json",
        report_file="tier7_5c_report.md",
        summary_file="tier7_5c_summary.csv",
        harness="experiments/tier7_5c_curriculum_environment_scoring_gate.py",
        evidence_role="curriculum/environment-generator scoring gate",
        claim="Tier 7.5c scores the locked Tier 7.5b generated task families and confirms a generated-family software signal for current CRA v2.4 against fair external baselines, v2.2 reference, and shams/ablations on hidden generated splits.",
        caveat="Synthetic generated-family scoring only; not public real-world usefulness proof, not a mechanism promotion by itself, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence. Because the generator grammar is aligned with keyed/compositional features, Tier 7.5d attribution/promotion is required before any stronger claim.",
        latest_manifest_names=("tier7_5c_latest_manifest.json",),
        expected_extra_files=(
            "tier7_5c_score_rows.csv",
            "tier7_5c_model_summary.csv",
            "tier7_5c_family_decisions.csv",
            "tier7_5c_statistical_support.csv",
            "tier7_5c_sample_efficiency.csv",
            "tier7_5c_sham_controls.csv",
            "tier7_5c_decision.json",
            "tier7_5c_decision.csv",
            "tier7_5c_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_5d_curriculum_environment_attribution_closeout",
        tier_label="Tier 7.5d - Curriculum / Environment Score Attribution + Promotion Decision",
        plan_position="Phase H generality: generated-family attribution closeout after Tier 7.5c",
        canonical_dir="tier7_5d_20260509_curriculum_environment_attribution_closeout",
        results_file="tier7_5d_results.json",
        report_file="tier7_5d_report.md",
        summary_file="tier7_5d_summary.csv",
        harness="experiments/tier7_5d_curriculum_environment_attribution_closeout.py",
        evidence_role="curriculum/environment-generator attribution closeout",
        claim="Tier 7.5d reconciles the Tier 7.5c generated-family scoring result: synthetic keyed/compositional mechanism attribution is supported across all locked generated families, while near-oracle generator-feature alignment risk is documented and public-usefulness, freeze, and hardware-transfer claims are blocked.",
        caveat="Attribution/decision evidence only; not new performance scoring, not public real-world usefulness proof, not a new software baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_5d_latest_manifest.json",),
        expected_extra_files=(
            "tier7_5d_attribution_checks.csv",
            "tier7_5d_claim_decisions.csv",
            "tier7_5d_route_decisions.csv",
            "tier7_5d_risk_register.csv",
            "tier7_5d_decision.json",
            "tier7_5d_decision.csv",
            "tier7_5d_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_6a_long_horizon_planning_contract",
        tier_label="Tier 7.6a - Long-Horizon Planning / Subgoal Control Contract",
        plan_position="Phase H generality: long-horizon planning/subgoal-control contract after Tier 7.5d",
        canonical_dir="tier7_6a_20260509_long_horizon_planning_contract",
        results_file="tier7_6a_results.json",
        report_file="tier7_6a_report.md",
        summary_file="tier7_6a_summary.csv",
        harness="experiments/tier7_6a_long_horizon_planning_contract.py",
        evidence_role="long-horizon planning/subgoal-control contract",
        claim="Tier 7.6a locks the bounded long-horizon planning/subgoal-control contract before implementation or scoring: task families, splits, baselines, shams, metrics, leakage guards, pass/fail gates, nonclaims, and expected artifacts are predeclared.",
        caveat="Contract evidence only; not planning performance, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_6a_latest_manifest.json",),
        expected_extra_files=(
            "tier7_6a_task_families.csv",
            "tier7_6a_split_contract.csv",
            "tier7_6a_baseline_inventory.csv",
            "tier7_6a_sham_controls.csv",
            "tier7_6a_metrics.csv",
            "tier7_6a_leakage_guards.csv",
            "tier7_6a_pass_fail_gates.csv",
            "tier7_6a_nonclaims.csv",
            "tier7_6a_expected_artifacts.csv",
            "tier7_6a_decision.json",
            "tier7_6a_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_6b_long_horizon_planning_local_diagnostic",
        tier_label="Tier 7.6b - Long-Horizon Planning / Subgoal-Control Local Diagnostic",
        plan_position="Phase H generality: bounded local planning/subgoal-control diagnostic after Tier 7.6a",
        canonical_dir="tier7_6b_20260509_long_horizon_planning_local_diagnostic",
        results_file="tier7_6b_results.json",
        report_file="tier7_6b_report.md",
        summary_file="tier7_6b_summary.csv",
        harness="experiments/tier7_6b_long_horizon_planning_local_diagnostic.py",
        evidence_role="long-horizon planning/subgoal-control local diagnostic",
        claim="Tier 7.6b scores a bounded local subgoal-control scaffold against reactive v2.4, no-planning ablations, simple planning/RL baselines, sequence baselines, and destructive shams. The candidate passes the locked local diagnostic and routes to attribution/promotion.",
        caveat="Local software diagnostic scaffold only; not a promoted CRA mechanism, not broad planning, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_6b_latest_manifest.json",),
        expected_extra_files=(
            "tier7_6b_task_contract.json",
            "tier7_6b_episode_score_rows.csv",
            "tier7_6b_model_summary.csv",
            "tier7_6b_family_model_summary.csv",
            "tier7_6b_subgoal_trace_rows.csv",
            "tier7_6b_sham_controls.csv",
            "tier7_6b_statistical_support.csv",
            "tier7_6b_family_decisions.csv",
            "tier7_6b_claim_boundary.md",
            "tier7_6b_decision.json",
            "tier7_6b_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_6c_long_horizon_planning_attribution_closeout",
        tier_label="Tier 7.6c - Long-Horizon Planning / Subgoal-Control Attribution + Promotion Decision",
        plan_position="Phase H generality: attribution closeout after Tier 7.6b local scaffold signal",
        canonical_dir="tier7_6c_20260509_long_horizon_planning_attribution_closeout",
        results_file="tier7_6c_results.json",
        report_file="tier7_6c_report.md",
        summary_file="tier7_6c_summary.csv",
        harness="experiments/tier7_6c_long_horizon_planning_attribution_closeout.py",
        evidence_role="long-horizon planning/subgoal-control attribution closeout",
        claim="Tier 7.6c preserves the Tier 7.6b local scaffold signal as a diagnostic result while blocking promotion, freeze, broad planning, and hardware/native transfer because feature-alignment risk remains high and reduced-feature generalization has not run.",
        caveat="Attribution/decision evidence only; not new performance scoring, not a promoted planning mechanism, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_6c_latest_manifest.json",),
        expected_extra_files=(
            "tier7_6c_attribution_checks.csv",
            "tier7_6c_promotion_decisions.csv",
            "tier7_6c_risk_register.csv",
            "tier7_6c_route_decisions.csv",
            "tier7_6c_claim_boundary.md",
            "tier7_6c_decision.json",
            "tier7_6c_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_6d_reduced_feature_planning_generalization",
        tier_label="Tier 7.6d - Reduced-Feature Planning Generalization / Task Repair",
        plan_position="Phase H generality: reduced-feature planning repair after Tier 7.6c blocked promotion",
        canonical_dir="tier7_6d_20260509_reduced_feature_planning_generalization",
        results_file="tier7_6d_results.json",
        report_file="tier7_6d_report.md",
        summary_file="tier7_6d_summary.csv",
        harness="experiments/tier7_6d_reduced_feature_planning_generalization.py",
        evidence_role="reduced-feature planning/subgoal-control generalization diagnostic",
        claim="Tier 7.6d repairs the Tier 7.6c feature-alignment blocker by rerunning the planning diagnostic with direct raw keys hidden and aliased/coarse features only. The reduced-feature signal is supported on 4/5 families, including the two prior weak families, and authorizes a promotion/compact-regression gate.",
        caveat="Reduced-feature local diagnostic only; not a promoted planning mechanism, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_6d_latest_manifest.json",),
        expected_extra_files=(
            "tier7_6d_reduced_feature_contract.json",
            "tier7_6d_episode_score_rows.csv",
            "tier7_6d_model_summary.csv",
            "tier7_6d_family_model_summary.csv",
            "tier7_6d_family_decisions.csv",
            "tier7_6d_subgoal_trace_rows.csv",
            "tier7_6d_sham_controls.csv",
            "tier7_6d_statistical_support.csv",
            "tier7_6d_claim_boundary.md",
            "tier7_6d_decision.json",
            "tier7_6d_decision.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_6e_planning_promotion_compact_regression",
        tier_label="Tier 7.6e - Planning/Subgoal-Control Promotion + Compact Regression",
        plan_position="Phase H generality: promotion gate after Tier 7.6d reduced-feature planning repair",
        canonical_dir="tier7_6e_20260509_planning_promotion_compact_regression",
        results_file="tier7_6e_results.json",
        report_file="tier7_6e_report.md",
        summary_file="tier7_6e_summary.csv",
        harness="experiments/tier7_6e_planning_promotion_compact_regression.py",
        evidence_role="planning/subgoal-control software promotion and compact regression gate",
        claim="Tier 7.6e promotes the reduced-feature planning/subgoal-control mechanism into the bounded host-side software baseline line after the locked Tier 7.6d signal and full NEST compact regression both pass. It authorizes the v2.5 software baseline freeze.",
        caveat="Software promotion/regression evidence only; not public usefulness proof, not broad planning or reasoning, not hardware/native transfer, not autonomous on-chip planning, and not AGI/ASI evidence.",
        latest_manifest_names=("tier7_6e_latest_manifest.json",),
        expected_extra_files=(
            "tier7_6e_promotion.json",
            "tier7_6e_promotion.csv",
            "tier7_6e_compact_child.json",
            "tier7_6e_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7a_v2_5_standardized_scoreboard_contract",
        tier_label="Tier 7.7a - v2.5 Standardized Benchmark / Usefulness Scoreboard Contract",
        plan_position="Phase H usefulness: pre-registration contract before scoring frozen v2.5 on public/standardized benchmarks",
        canonical_dir="tier7_7a_20260509_v2_5_standardized_scoreboard_contract",
        results_file="tier7_7a_results.json",
        report_file="tier7_7a_report.md",
        summary_file="tier7_7a_summary.csv",
        harness="experiments/tier7_7a_v2_5_standardized_scoreboard_contract.py",
        evidence_role="standardized benchmark/usefulness scoreboard pre-registration contract",
        claim="Tier 7.7a locks the v2.5 public/standardized benchmark contract before scoring: Mackey-Glass, Lorenz, and NARMA10 at 8000 steps with seeds 42/43/44 form the primary scoreboard, while C-MAPSS FD001 and NAB are secondary public/real-ish confirmation tracks only.",
        caveat="Contract/pre-registration evidence only; not a benchmark score, not public usefulness proof, not a new baseline freeze, not hardware/native transfer, and not language, broad planning, AGI, or ASI evidence.",
        latest_manifest_names=("tier7_7a_latest_manifest.json",),
        expected_extra_files=(
    ...
    EvidenceSpec(
        entry_id="tier7_7b_v2_5_standardized_scoreboard_scoring_gate",
        tier_label="Tier 7.7b - v2.5 Standardized Benchmark / Usefulness Scoreboard Scoring Gate",
        plan_position="Phase H usefulness: locked 7.7a standardized scoreboard scoring gate for frozen v2.5",
        canonical_dir="tier7_7b_20260509_v2_5_standardized_scoreboard_scoring_gate",
        results_file="tier7_7b_results.json",
        report_file="tier7_7b_report.md",
        summary_file="tier7_7b_summary.csv",
        harness="experiments/tier7_7b_v2_5_standardized_scoreboard_scoring_gate.py",
        evidence_role="standardized benchmark/usefulness scoreboard scoring gate",
        claim="Tier 7.7b passed as a locked scoring gate and found standardized progress versus v2.3 on the 8000-step Mackey-Glass/Lorenz/NARMA10 aggregate: v2.5 geomean MSE 0.0735414741 versus v2.3 0.0951071342, ratio 1.2932448715, paired delta CI 0.0197948122 to 0.0244083440. The signal is one-task-driven: Mackey-Glass improved, while Lorenz and NARMA10 were flat/slightly worse.",
        caveat="Scoring evidence only; not a new baseline freeze, not hardware/native evidence, not broad public usefulness, not external-baseline superiority, and not language, broad planning, AGI, or ASI evidence. ESN, online LMS, and ridge/lag baselines still beat v2.5 on aggregate.",
        latest_manifest_names=("tier7_7b_latest_manifest.json",),
        expected_extra_files=(
    ...
    EvidenceSpec(
        entry_id="tier7_7c_standardized_long_run_failure_contract",
        tier_label="Tier 7.7c - Standardized Long-Run / Failure-Localization Contract",
        plan_position="Phase H usefulness: pre-registration contract after Tier 7.7b localized standardized-progress result",
        canonical_dir="tier7_7c_20260509_standardized_long_run_failure_contract",
        results_file="tier7_7c_results.json",
        report_file="tier7_7c_report.md",
        summary_file="tier7_7c_summary.csv",
        harness="experiments/tier7_7c_standardized_long_run_failure_contract.py",
        evidence_role="standardized long-run/failure-localization pre-registration contract",
        claim="Tier 7.7c locks the post-7.7b long-run failure-localization contract before scoring: Mackey-Glass, Lorenz, and NARMA10 remain fixed with seeds 42/43/44, required lengths 8000/16000/32000, optional diagnostic length 50000, and explicit diagnostics for Mackey signal persistence, Lorenz state-reconstruction gap, NARMA10 memory-depth gap, external-baseline gap, and sham specificity.",
        caveat="Contract/pre-registration evidence only; not a long-run score, not a baseline freeze, not public usefulness proof, not hardware/native transfer, and not language, broad planning, AGI, or ASI evidence.",
        latest_manifest_names=("tier7_7c_latest_manifest.json",),
        expected_extra_files=(
    ...
    EvidenceSpec(
        entry_id="tier7_7d_standardized_long_run_failure_scoring_gate",
        tier_label="Tier 7.7d - Standardized Long-Run / Failure-Localization Scoring Gate",
        plan_position="Phase H usefulness: scoring the Tier 7.7c long-run/failure-localization contract",
        canonical_dir="tier7_7d_20260509_standardized_long_run_failure_scoring_gate",
        results_file="tier7_7d_results.json",
        report_file="tier7_7d_report.md",
        summary_file="tier7_7d_summary.csv",
        harness="experiments/tier7_7d_standardized_long_run_failure_scoring_gate.py",
        evidence_role="standardized long-run/failure-localization scoring blocker",
        claim="Tier 7.7d executed the locked long-run scoring harness and classified the result as benchmark_stream_invalid: Mackey-Glass ratios persisted across 8000/16000/32000, Lorenz did not materially improve, external baselines still remained blockers, and the required NARMA10 stream became non-finite at 16000 and 32000 with the existing generator.",
        caveat="Scoring-blocker evidence only; not a complete long-run scoreboard, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not language, broad planning, AGI, or ASI evidence. NARMA10 long-run generation must be repaired/preflighted before citable long-run standardized scoring.",
        latest_manifest_names=("tier7_7d_latest_manifest.json",),
        expected_extra_files=(
    ...
    EvidenceSpec(
        entry_id="tier7_7e_finite_stream_repair_preflight",
        tier_label="Tier 7.7e - Finite-Stream Repair / Preflight Contract",
        plan_position="Phase H usefulness: repair/preflight after Tier 7.7d benchmark-stream invalid blocker",
        canonical_dir="tier7_7e_20260509_finite_stream_repair_preflight",
        results_file="tier7_7e_results.json",
        report_file="tier7_7e_report.md",
        summary_file="tier7_7e_summary.csv",
        harness="experiments/tier7_7e_finite_stream_repair_preflight.py",
        evidence_role="finite-stream benchmark repair preflight",
        claim="Tier 7.7e reproduced the original long-run NARMA10 finite-stream blocker and selected a predeclared repaired NARMA10 generator: same recurrence coefficients with reduced input range U(0,0.2). The selected repair passed all 9 required length/seed cells across 8000/16000/32000 and seeds 42/43/44.",
        caveat="Benchmark repair/preflight evidence only; not a CRA score, not public usefulness proof, not a baseline freeze, not hardware/native transfer, and not permission to silently merge repaired U(0,0.2) NARMA results with prior U(0,0.5) NARMA scores.",
        latest_manifest_names=("tier7_7e_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7e_finite_stream_contract.json",
            "tier7_7e_stream_preflight.csv",
            "tier7_7e_generator_options.csv",
            "tier7_7e_generator_summary.csv",
            "tier7_7e_standard_failure_reproduction.csv",
            "tier7_7e_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7f_repaired_finite_stream_long_run_scoreboard",
        tier_label="Tier 7.7f - Repaired Finite-Stream Long-Run Scoreboard",
        plan_position="Phase H usefulness: repaired long-run scoring after Tier 7.7e finite-stream preflight",
        canonical_dir="tier7_7f_20260509_repaired_finite_stream_long_run_scoreboard",
        results_file="tier7_7f_results.json",
        report_file="tier7_7f_report.md",
        summary_file="tier7_7f_summary.csv",
        harness="experiments/tier7_7f_repaired_finite_stream_long_run_scoreboard.py",
        evidence_role="repaired standardized long-run scoreboard",
        claim="Tier 7.7f reran the locked long-run scoreboard using the repaired NARMA10 U(0,0.2) stream and produced a valid finite-stream classification: mackey_only_localized. Mackey-Glass persisted across 8000/16000/32000, while Lorenz stayed flat/weak, repaired NARMA10 stayed near-flat, and ESN remained the best external baseline.",
        caveat="Scoring evidence only; not a baseline freeze, not hardware/native evidence, not broad public usefulness, not external-baseline superiority, and not permission to mix repaired U(0,0.2) NARMA scores with prior U(0,0.5) NARMA scores.",
        latest_manifest_names=("tier7_7f_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7f_length_scoreboard.csv",
            "tier7_7f_length_aggregate.csv",
            "tier7_7f_failure_decomposition.csv",
            "tier7_7f_sham_controls.csv",
            "tier7_7f_leakage_audit.json",
            "tier7_7f_repaired_stream_manifest.json",
            "tier7_7f_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7g_lorenz_capacity_narma_memory_contract",
        tier_label="Tier 7.7g - Lorenz State-Capacity / NARMA Memory-Depth Diagnostic Contract",
        plan_position="Phase H usefulness: capacity/state-interface contract after Tier 7.7f Mackey-only localization",
        canonical_dir="tier7_7g_20260509_lorenz_capacity_narma_memory_contract",
        results_file="tier7_7g_results.json",
        report_file="tier7_7g_report.md",
        summary_file="tier7_7g_summary.csv",
        harness="experiments/tier7_7g_lorenz_capacity_narma_memory_contract.py",
        evidence_role="capacity/state-interface diagnostic pre-registration contract",
        claim="Tier 7.7g locks the Lorenz state-capacity / repaired-NARMA memory-depth diagnostic before scoring: CRA temporal-state capacity 16/32/64/128, matched-capacity ESN and random-reservoir references, repaired NARMA U(0,0.2), Mackey positive-control anchor, shams, metrics, and decision classes.",
        caveat="Contract/pre-registration evidence only; not a score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7g_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7g_capacity_contract.json",
            "tier7_7g_task_matrix.csv",
            "tier7_7g_capacity_matrix.csv",
            "tier7_7g_diagnostic_questions.csv",
            "tier7_7g_shams.csv",
            "tier7_7g_pass_fail_criteria.csv",
            "tier7_7g_expected_artifacts.csv",
            "tier7_7g_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7h_lorenz_capacity_narma_memory_scoring_gate",
        tier_label="Tier 7.7h - Lorenz Capacity / NARMA Memory-Depth Scoring Gate",
        plan_position="Phase H usefulness: scored capacity/state-interface diagnostic after Tier 7.7g contract",
        canonical_dir="tier7_7h_20260509_lorenz_capacity_narma_memory_scoring_gate",
        results_file="tier7_7h_results.json",
        report_file="tier7_7h_report.md",
        summary_file="tier7_7h_summary.csv",
        harness="experiments/tier7_7h_lorenz_capacity_narma_memory_scoring_gate.py",
        evidence_role="capacity/state-interface diagnostic scoring gate",
        claim="Tier 7.7h scored the locked Lorenz/NARMA capacity matrix. Capacity improved Mackey-Glass and Lorenz materially, but the gate classified the result as overfit_or_sham_blocked because Lorenz did not separate from the permuted-recurrence sham at the best capacity; repaired NARMA improved only weakly.",
        caveat="Scoring evidence only; not a baseline freeze, not a mechanism promotion, not hardware/native evidence, not public usefulness evidence, and not external-baseline superiority.",
        latest_manifest_names=("tier7_7h_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7h_capacity_scoreboard.csv",
            "tier7_7h_capacity_summary.csv",
            "tier7_7h_capacity_curves.csv",
            "tier7_7h_capacity_aggregate.csv",
            "tier7_7h_matched_capacity_baselines.csv",
            "tier7_7h_sham_controls.csv",
            "tier7_7h_repaired_stream_manifest.json",
            "tier7_7h_task_descriptors.json",
            "tier7_7h_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7i_capacity_sham_separation_contract",
        tier_label="Tier 7.7i - Capacity Sham-Separation / State-Specificity Contract",
        plan_position="Phase H usefulness: state-specificity contract after Tier 7.7h sham-blocked capacity result",
        canonical_dir="tier7_7i_20260509_capacity_sham_separation_contract",
        results_file="tier7_7i_results.json",
        report_file="tier7_7i_report.md",
        summary_file="tier7_7i_summary.csv",
        harness="experiments/tier7_7i_capacity_sham_separation_contract.py",
        evidence_role="state-specificity diagnostic pre-registration contract",
        claim="Tier 7.7i locks the capacity sham-separation/state-specificity diagnostic before scoring: candidate recurrence, permuted-recurrence ensemble, state reset, orthogonal/block references, delay embedding, readout concentration, participation ratio, rank-95, top-PC dominance, state-kernel alignment, and negative outcome classes.",
        caveat="Contract/pre-registration evidence only; not a score, not a repair, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, and not public usefulness evidence.",
        latest_manifest_names=("tier7_7i_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7i_contract.json",
            "tier7_7i_tasks.csv",
            "tier7_7i_probe_families.csv",
            "tier7_7i_metrics.csv",
            "tier7_7i_outcome_classes.csv",
            "tier7_7i_expected_artifacts.csv",
            "tier7_7i_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7j_capacity_sham_separation_scoring_gate",
        tier_label="Tier 7.7j - Capacity Sham-Separation / State-Specificity Scoring Gate",
        plan_position="Phase H usefulness: scored state-specificity diagnostic after Tier 7.7i contract",
        canonical_dir="tier7_7j_20260509_capacity_sham_separation_scoring_gate",
        results_file="tier7_7j_results.json",
        report_file="tier7_7j_report.md",
        summary_file="tier7_7j_summary.csv",
        harness="experiments/tier7_7j_capacity_sham_separation_scoring_gate.py",
        evidence_role="state-specificity diagnostic scoring gate",
        claim="Tier 7.7j scored the locked state-specificity diagnostic and classified the Lorenz high-capacity signal as low_rank_collapse_confirmed: candidate and probe states stayed near participation ratio 2 despite larger nominal capacity, while target/time shuffles separated and readout concentration did not explain the failure.",
        caveat="Diagnostic scoring evidence only; not a repair, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7j_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7j_scoreboard.csv",
            "tier7_7j_score_summary.csv",
            "tier7_7j_state_geometry.csv",
            "tier7_7j_state_geometry_summary.csv",
            "tier7_7j_state_kernel_alignment.csv",
            "tier7_7j_state_kernel_alignment_summary.csv",
            "tier7_7j_readout_concentration.csv",
            "tier7_7j_readout_concentration_summary.csv",
            "tier7_7j_task_descriptors.json",
            "tier7_7j_probe_manifest.json",
            "tier7_7j_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7k_effective_state_dimensionality_repair_contract",
        tier_label="Tier 7.7k - Effective-State-Dimensionality Repair Contract",
        plan_position="Phase H usefulness: repair pre-registration after Tier 7.7j low-rank-collapse finding",
        canonical_dir="tier7_7k_20260509_effective_state_dimensionality_repair_contract",
        results_file="tier7_7k_results.json",
        report_file="tier7_7k_report.md",
        summary_file="tier7_7k_summary.csv",
        harness="experiments/tier7_7k_effective_state_dimensionality_repair_contract.py",
        evidence_role="effective-state-dimensionality repair pre-registration contract",
        claim="Tier 7.7k locks the next repair before implementation: partitioned causal drivers plus diverse recurrent state should reduce shared-driver synchronization, raise effective state dimensionality under Lorenz pressure, and separate from generic/permuted/block shams while preserving Mackey and repaired NARMA guards.",
        caveat="Contract/pre-registration evidence only; not a repair implementation, not a score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7k_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7k_contract.json",
            "tier7_7k_mechanisms.csv",
            "tier7_7k_failure_hypotheses.csv",
            "tier7_7k_tasks.csv",
            "tier7_7k_metrics.csv",
            "tier7_7k_controls.csv",
            "tier7_7k_outcome_classes.csv",
            "tier7_7k_expected_artifacts.csv",
            "tier7_7k_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7l_effective_state_dimensionality_repair_scoring_gate",
        tier_label="Tier 7.7l - Effective-State-Dimensionality Repair Scoring Gate",
        plan_position="Phase H usefulness: scored repair gate after Tier 7.7k contract",
        canonical_dir="tier7_7l_20260509_effective_state_dimensionality_repair_scoring_gate",
        results_file="tier7_7l_results.json",
        report_file="tier7_7l_report.md",
        summary_file="tier7_7l_summary.csv",
        harness="experiments/tier7_7l_effective_state_dimensionality_repair_scoring_gate.py",
        evidence_role="effective-state-dimensionality repair diagnostic scoring gate",
        claim="Tier 7.7l scored the locked repair and classified the result as task_gain_without_dimension: partitioned causal drivers substantially improved Lorenz, Mackey-Glass, and repaired NARMA against the single-pool reference, but the predeclared effective-dimensionality threshold and diversity-pressure attribution were not met.",
        caveat="Diagnostic scoring evidence only; not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7l_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7l_scoreboard.csv",
            "tier7_7l_score_summary.csv",
            "tier7_7l_state_geometry.csv",
            "tier7_7l_state_geometry_summary.csv",
            "tier7_7l_state_kernel_alignment.csv",
            "tier7_7l_state_kernel_alignment_summary.csv",
            "tier7_7l_readout_concentration.csv",
            "tier7_7l_readout_concentration_summary.csv",
            "tier7_7l_sham_controls.csv",
            "tier7_7l_regression_summary.json",
            "tier7_7l_task_descriptors.json",
            "tier7_7l_probe_manifest.json",
            "tier7_7l_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7m_partitioned_driver_attribution_contract",
        tier_label="Tier 7.7m - Partitioned-Driver Attribution Contract",
        plan_position="Phase H usefulness: attribution contract after Tier 7.7l task gain without dimensionality repair",
        canonical_dir="tier7_7m_20260509_partitioned_driver_attribution_contract",
        results_file="tier7_7m_results.json",
        report_file="tier7_7m_report.md",
        summary_file="tier7_7m_summary.csv",
        harness="experiments/tier7_7m_partitioned_driver_attribution_contract.py",
        evidence_role="partitioned-driver gain attribution pre-registration contract",
        claim="Tier 7.7m locks the attribution plan for the Tier 7.7l task gain before any promotion: the next gate must distinguish causal driver partitioning from nonlinear/lag feature enrichment, readout/interface budget, diversity pressure, generic basis effects, leakage, or non-reproducible scoring noise.",
        caveat="Contract evidence only; not an attribution implementation, not a model score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7m_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7m_contract.json",
            "tier7_7m_attribution_hypotheses.csv",
            "tier7_7m_variants.csv",
            "tier7_7m_driver_group_ablations.csv",
            "tier7_7m_tasks.csv",
            "tier7_7m_metrics.csv",
            "tier7_7m_outcome_classes.csv",
            "tier7_7m_expected_artifacts.csv",
            "tier7_7m_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
