...
SPECS: tuple[EvidenceSpec, ...] = (
    ...
    EvidenceSpec(
        entry_id="tier7_7n_partitioned_driver_attribution_scoring_gate",
        tier_label="Tier 7.7n - Partitioned-Driver Attribution Scoring Gate",
        plan_position="Phase H usefulness: scored attribution gate after Tier 7.7m contract",
        canonical_dir="tier7_7n_20260509_partitioned_driver_attribution_scoring_gate",
        results_file="tier7_7n_results.json",
        report_file="tier7_7n_report.md",
        summary_file="tier7_7n_summary.csv",
        harness="experiments/tier7_7n_partitioned_driver_attribution_scoring_gate.py",
        evidence_role="partitioned-driver gain attribution scoring gate",
        claim="Tier 7.7n scored the locked attribution matrix and classified the 7.7l gain as generic_projection_explains_gain: the full partitioned driver remained useful versus single-pool, but same-feature random projection and nonlinear/lag unpartitioned controls explained or exceeded the gain.",
        caveat="Diagnostic scoring evidence only; not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7n_latest_manifest.json",),
        expected_extra_files=(
            ...
            "tier7_7n_task_descriptors.json",
            "tier7_7n_probe_manifest.json",
            "tier7_7n_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7o_generic_temporal_interface_reframing_contract",
        tier_label="Tier 7.7o - Generic Temporal-Interface Reframing Contract",
        plan_position="Phase H usefulness: reframing contract after Tier 7.7n generic-interface attribution block",
        canonical_dir="tier7_7o_20260509_generic_temporal_interface_reframing_contract",
        results_file="tier7_7o_results.json",
        report_file="tier7_7o_report.md",
        summary_file="tier7_7o_summary.csv",
        harness="experiments/tier7_7o_generic_temporal_interface_reframing_contract.py",
        evidence_role="generic temporal-interface reframing pre-registration contract",
        claim="Tier 7.7o closes the partitioned-driver repair path as non-promoted, makes random-projection/nonlinear-lag controls mandatory, and authorizes a separate CRA-native temporal-interface internalization contract.",
        caveat="Contract evidence only; not a mechanism implementation, not a model score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7o_latest_manifest.json",),
        expected_extra_files=(
            ...
            "tier7_7o_expected_artifacts.csv",
            "tier7_7o_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7p_cra_native_temporal_interface_internalization_contract",
        tier_label="Tier 7.7p - CRA-Native Temporal-Interface Internalization Contract",
        plan_position="Phase H usefulness: internalization contract after Tier 7.7o reframed generic temporal-interface controls",
        canonical_dir="tier7_7p_20260509_cra_native_temporal_interface_internalization_contract",
        results_file="tier7_7p_results.json",
        report_file="tier7_7p_report.md",
        summary_file="tier7_7p_summary.csv",
        harness="experiments/tier7_7p_cra_native_temporal_interface_internalization_contract.py",
        evidence_role="CRA-native temporal-interface internalization pre-registration contract",
        claim="Tier 7.7p locks a CRA-native temporal-interface internalization candidate: sparse causal temporal expansion with delay/trace and nonlinear branch units must beat or cleanly separate from random-projection and nonlinear-lag controls before any promotion.",
        caveat="Contract evidence only; not a mechanism implementation, not a model score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7p_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7p_contract.json",
            "tier7_7p_mechanisms.csv",
            "tier7_7p_implementation_constraints.csv",
            "tier7_7p_tasks.csv",
            "tier7_7p_controls.csv",
            "tier7_7p_metrics.csv",
            "tier7_7p_outcome_classes.csv",
            "tier7_7p_expected_artifacts.csv",
            "tier7_7p_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7q_cra_native_temporal_interface_internalization_scoring_gate",
        tier_label="Tier 7.7q - CRA-Native Temporal-Interface Internalization Scoring Gate",
        plan_position="Phase H usefulness: scoring gate after Tier 7.7p native temporal-interface contract",
        canonical_dir="tier7_7q_20260509_cra_native_temporal_interface_internalization_scoring_gate",
        results_file="tier7_7q_results.json",
        report_file="tier7_7q_report.md",
        summary_file="tier7_7q_summary.csv",
        harness="experiments/tier7_7q_cra_native_temporal_interface_internalization_scoring_gate.py",
        evidence_role="CRA-native temporal-interface internalization scoring gate",
        claim="Tier 7.7q scored the locked CRA-native sparse temporal expansion candidate and classified the outcome as external_controls_still_win: the native candidate improved over current CRA on Lorenz/Mackey/NARMA and passed shuffle guards, but same-feature random projection and nonlinear-lag controls still beat the key Lorenz claim.",
        caveat="Diagnostic scoring evidence only; not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7q_latest_manifest.json",),
        expected_extra_files=(
            ...
            "tier7_7q_state_geometry_summary.csv",
            "tier7_7q_strong_controls.csv",
            "tier7_7q_regression_summary.json",
            "tier7_7q_task_descriptors.json",
            "tier7_7q_probe_manifest.json",
            "tier7_7q_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7r_native_temporal_basis_reframing_contract",
        tier_label="Tier 7.7r - Native Temporal-Basis Repair/Reframing Contract",
        plan_position="Phase H usefulness: reframing contract after Tier 7.7q useful-but-not-mechanism-promoted score",
        canonical_dir="tier7_7r_20260509_native_temporal_basis_reframing_contract",
        results_file="tier7_7r_results.json",
        report_file="tier7_7r_report.md",
        summary_file="tier7_7r_summary.csv",
        harness="experiments/tier7_7r_native_temporal_basis_reframing_contract.py",
        evidence_role="temporal-basis utility/mechanism split pre-registration contract",
        claim="Tier 7.7r preserves the positive Tier 7.7q utility signal while splitting bounded engineering/interface promotion from stricter CRA-specific mechanism promotion; the next gate is a bounded temporal-basis utility promotion/regression gate.",
        caveat="Contract evidence only; not a new score, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7r_latest_manifest.json",),
        expected_extra_files=(
    ...
    EvidenceSpec(
        entry_id="tier7_7s_bounded_temporal_basis_utility_promotion",
        tier_label="Tier 7.7s - Bounded Temporal-Basis Utility Promotion/Regression Gate",
        plan_position="Phase H usefulness: utility promotion gate after Tier 7.7r split utility from mechanism promotion",
        canonical_dir="tier7_7s_20260509_bounded_temporal_basis_utility_promotion",
        results_file="tier7_7s_results.json",
        report_file="tier7_7s_report.md",
        summary_file="tier7_7s_summary.csv",
        harness="experiments/tier7_7s_bounded_temporal_basis_utility_promotion.py",
        evidence_role="bounded temporal-basis engineering utility promotion/regression gate",
        claim="Tier 7.7s promotes the temporal-basis interface as bounded engineering utility after the Tier 7.7q utility signal, Tier 7.7r reframing contract, and repository pytest regression guard pass; it explicitly does not promote a CRA-specific mechanism.",
        caveat="Bounded engineering utility evidence only; not a CRA-specific mechanism promotion, not a core baseline freeze, not hardware/native transfer, not external-baseline superiority, and not broad public usefulness evidence.",
        latest_manifest_names=("tier7_7s_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7s_task_ratios.csv",
            "tier7_7s_utility_decision.csv",
            "tier7_7s_compact_child.json",
            "tier7_7s_claim_boundary.md",
            "compact_regression_pytest/__returncode__",
            "compact_regression_pytest/compact_regression_pytest_stdout.log",
            "compact_regression_pytest/compact_regression_pytest_stderr.log",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7t_low_rank_state_repair_campaign_contract",
        tier_label="Tier 7.7t - Low-Rank State Repair Campaign Contract",
        plan_position="Phase H usefulness: low-rank repair campaign contract after Tier 7.7s bounded temporal-basis utility promotion",
        canonical_dir="tier7_7t_20260509_low_rank_state_repair_campaign_contract",
        results_file="tier7_7t_results.json",
        report_file="tier7_7t_report.md",
        summary_file="tier7_7t_summary.csv",
        harness="experiments/tier7_7t_low_rank_state_repair_campaign_contract.py",
        evidence_role="campaign contract for repairing the low-rank state bottleneck",
        claim="Tier 7.7t locks the Tier 7.7 low-rank state repair campaign without implementing or scoring any repair candidate. It predeclares 8 failure modes, 5 repair families (A-E), mandatory random-projection and nonlinear-lag controls, state-geometry and task metrics, 13 outcome classes, baseline escalation rules, stopping rules, and route conditions to Tier 7.8 and 7.9.",
        caveat="Contract only; not a repair implementation, not model scoring, not mechanism promotion, not a baseline freeze, not public usefulness proof, not hardware/native transfer, and not language/AGI/ASI evidence.",
        latest_manifest_names=("tier7_7t_latest_manifest.json",),
        expected_extra_files=(
    ...
    EvidenceSpec(
        entry_id="tier7_7u_state_collapse_causal_localization",
        tier_label="Tier 7.7u - State-Collapse Causal Localization",
        plan_position="Phase H usefulness: causal localization gate after Tier 7.7t campaign contract",
        canonical_dir="tier7_7u_20260509_state_collapse_causal_localization",
        results_file="tier7_7u_results.json",
        report_file="tier7_7u_report.md",
        summary_file="tier7_7u_summary.csv",
        harness="experiments/tier7_7u_state_collapse_causal_localization.py",
        evidence_role="causal localization protocol lock",
        claim="Tier 7.7u locks the localization protocol for the low-rank state collapse. It declares 10 probe definitions, 7 required diagnostic model variants (no_plasticity, no_inhibition, frozen_recurrent, state_reset, input_channel_shuffle, per_partition_probe, trophic_probe), 7 diagnostic controls with availability status, and 9 outcome classification rules. Full causal scoring awaits model-variant implementation.",
        caveat="Protocol lock only; not full localization scoring, not repair implementation, not mechanism promotion, not a baseline freeze, not public usefulness proof, and not hardware/native transfer.",
        latest_manifest_names=("tier7_7u_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7u_contract.json",
            "tier7_7u_probe_definitions.csv",
            "tier7_7u_required_variants.csv",
            "tier7_7u_diagnostic_controls.csv",
            "tier7_7u_outcome_rules.csv",
            "tier7_7u_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7v_r0_diagnostic_model_variants",
        tier_label="Tier 7.7v-r0 - Diagnostic Model Variant Implementation",
        plan_position="Phase H usefulness: model variant infrastructure before Tier 7.7v repair",
        canonical_dir="tier7_7v_r0_20260509_diagnostic_model_variants",
        results_file="tier7_7v_r0_results.json",
        report_file="tier7_7v_r0_report.md",
        summary_file="tier7_7v_r0_summary.csv",
        harness="experiments/tier7_7v_r0_diagnostic_model_variants.py",
        evidence_role="diagnostic model variant implementation and verification",
        claim="Tier 7.7v-r0 extends tier7_7j.basis_features with random_recurrent and shuffled_input diagnostic modes, declares 6 variant registry entries (orthogonal, block, frozen_recurrent, shuffled_input, no_plasticity, state_reset), and verifies all variants produce state geometry with distinct participation ratios. This provides the infrastructure needed for Tier 7.7u causal localization probes.",
        caveat="Model variant implementation and verification only; not a repair, not mechanism promotion, not a baseline freeze, not public usefulness proof, and not hardware/native transfer.",
        latest_manifest_names=("tier7_7v_r0_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7v_r0_variants.csv",
            "tier7_7v_r0_verification.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7v_repair_candidate_compact_score",
        tier_label="Tier 7.7v - Repair Candidate Compact Score (Family B)",
        plan_position="Phase H usefulness: compact repair scoring after 7.7v-r0 model variants",
        canonical_dir="tier7_7v_20260509_repair_candidate_compact_score",
        results_file="tier7_7v_results.json",
        report_file="tier7_7v_report.md",
        summary_file="tier7_7v_variant_summary.csv",
        harness="experiments/tier7_7v_repair_candidate_compact_score.py",
        evidence_role="compact repair candidate scoring (Family B: independent causal subspace drivers)",
        claim="Tier 7.7v scores the Repair Family B candidate (orthogonalized input projections + block-structured recurrence) on Mackey-Glass/Lorenz/repaired-NARMA10 at 8000 steps, seed 42. The candidate achieves PR=5.49 vs orthogonal baseline PR=2.01, beats the shuffled_input control (PR=4.57), and confirms the input-encoder bottleneck as the primary low-rank collapse mechanism.",
        caveat="Compact repair scoring on one seed only; not expanded confirmation at longer lengths/more seeds, not mechanism promotion, not a baseline freeze, not public usefulness proof, and not hardware/native transfer.",
        latest_manifest_names=("tier7_7v_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7v_variant_summary.csv",
            "tier7_7v_diagnoses.csv",
            "tier7_7v_results.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7v_input_diversity_test",
        tier_label="Tier 7.7v-InputDiversity - Multi-Band Decomposition Hypothesis Test",
        plan_position="Phase H usefulness: input diversity hypothesis test after 7.7 repair campaign",
        canonical_dir="tier7_7v_input_diversity_20260509",
        results_file="tier7_7v_input_diversity_results.json",
        report_file="tier7_7v_input_diversity_report.md",
        summary_file="tier7_7v_input_diversity_summary.csv",
        harness="experiments/tier7_7v_input_diversity_test.py",
        evidence_role="input diversity hypothesis confirmation",
        claim="Tier 7.7v-InputDiversity confirms the input redundancy hypothesis: replacing the 7-element EMA trace bank (all convolving the same scalar x) with causal multi-lag temporal differencing at lags [1,2,4,8,16,32,64,128] restores state dimensionality. Diff-embedding PR=4.76 vs orthogonal baseline PR=2.01 (2.37x improvement) across Mackey-Glass/Lorenz/repaired-NARMA10 at 8000 steps, seeds 42/43/44. This identifies the EMA trace bank as the primary low-rank collapse bottleneck.",
        caveat="Input diversity hypothesis test only. Not a promoted mechanism, not a baseline freeze, not public usefulness proof, and not hardware/native transfer. Expanded confirmation at longer lengths needed before promotion.",
        latest_manifest_names=("tier7_7v_input_diversity_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7v_input_diversity_summary.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_8_polyp_morphology_contract",
        tier_label="Tier 7.8 - Polyp Morphology / Template Variability Contract",
        plan_position="Phase H usefulness: morphology contract after 7.7 campaign closeout",
        canonical_dir="tier7_8_20260509_polyp_morphology_contract",
        results_file="tier7_8_results.json",
        report_file="tier7_8_report.md",
        summary_file="tier7_8_summary.csv",
        harness="experiments/tier7_8_polyp_morphology_contract.py",
        evidence_role="morphology/template variability contract lock",
        claim="Tier 7.8 locks the polyp morphology testing protocol: 6 template candidates (diverse timescales, variable recurrence, E/I ratios, sparse connectivity, input selectivity, template size), 7 controls (homogeneous baseline, same-budget fixed-template, shuffled assignment, random projection, nonlinear-lag, target/time shuffle), 8 metrics (5 state geometry, 3 task), 6 outcome classes, 3 task families, 4-stage escalation. Contract only; no implementation or scoring.",
        caveat="Contract only; not a template implementation, not model scoring, not mechanism promotion, not a baseline freeze, and not hardware/native transfer.",
        latest_manifest_names=("tier7_8_latest_manifest.json",),
        expected_extra_files=(
            "tier7_8_contract.json",
            "tier7_8_candidates.csv",
            "tier7_8_controls.csv",
            "tier7_8_metrics.csv",
            "tier7_8_outcomes.csv",
            "tier7_8_tasks.csv",
            "tier7_8_escalation.csv",
            "tier7_8_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7z_r0_compact_regression",
        tier_label="Tier 7.7z-r0 - Edge-of-Chaos Compact Regression Gate",
        plan_position="Phase H usefulness: compact regression + baseline freeze after edge-of-chaos promotion",
        canonical_dir="tier7_7z_r0_20260509_compact_regression",
        results_file="tier7_7z_r0_results.json",
        report_file="tier7_7z_r0_report.md",
        summary_file="tier7_7z_r0_summary.csv",
        harness="experiments/tier7_7z_r0_compact_regression.py",
        evidence_role="compact regression gate + baseline freeze for edge-of-chaos recurrent dynamics",
        claim="Tier 7.7z-r0 runs compact regression (Tier 1-3 controls) on the edge-of-chaos mechanism: shuffled target hurts MSE (Tier 1), no-learning hurts MSE (Tier 2), ablation baseline loses PR (Tier 3). All controls pass across Mackey-Glass/Lorenz/NARMA10 at 8000-32000 steps, seeds 42/43/44. CRA_EVIDENCE_BASELINE_v2.6 frozen.",
        caveat="Compact regression on standalone reference implementation. Not full NEST organism regression. Not public usefulness proof. Not hardware/native transfer.",
        latest_manifest_names=("tier7_7z_r0_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7z_r0_scoreboard.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7z_r1_standardized_benchmark",
        tier_label="Tier 7.7z-r1 - v2.6 Standardized Benchmark Rerun",
        plan_position="Phase H usefulness: v2.6 benchmark after edge-of-chaos baseline freeze",
        canonical_dir="tier7_7z_r1_20260509_standardized_benchmark",
        results_file="tier7_7z_r1_results.json",
        report_file="tier7_7z_r1_report.md",
        summary_file="tier7_7z_r1_summary.csv",
        harness="experiments/tier7_7z_r1_standardized_benchmark.py",
        evidence_role="v2.6 standardized benchmark scoring",
        claim="Tier 7.7z-r1 scores v2.6 (edge-of-chaos + ridge) against ESN and lag-ridge baselines on Mackey-Glass/Lorenz/NARMA10 at 8000-32000 steps, seeds 42/43/44. v2.6 ridge MSE=1.90e-06 beats ESN ridge=5.30e-06 (2.8x), lag-ridge=4.81e-07 beats v2.6 (4x). Internal capability improved vs v2.5; strongest simple baseline (lag-ridge) still wins.",
        caveat="Benchmark scoring with ridge readout. v2.5 comparison uses different readout (online LMS) so ratio is not directly comparable. Not public usefulness proof. Not hardware/native transfer.",
        latest_manifest_names=("tier7_7z_r1_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7z_r1_scoreboard.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier5_45_healthy_nest_rebaseline_contract",
        tier_label="Tier 5.45 - Healthy-NEST Rebaseline Decision Contract",
        plan_position="Repo-alignment remediation Gate 5: clean rebaseline decision before new science claims",
        canonical_dir="tier5_45_20260514_healthy_nest_rebaseline_contract",
        results_file="tier5_45_results.json",
        report_file="tier5_45_report.md",
        summary_file="tier5_45_summary.csv",
        harness="experiments/tier5_45_healthy_nest_rebaseline_contract.py",
        evidence_role="healthy-NEST rebaseline scoring contract",
        claim="Tier 5.45 locks the post-cleanup healthy-NEST rebaseline decision protocol: compare v2.6, conservative organism defaults, 15 opt-in single-feature mechanism conditions, full opt-in stack, and external baselines across sine/Mackey-Glass/Lorenz/NARMA10, seeds 42/43/44, with zero synthetic fallback as a hard blocker.",
        caveat="Contract only; not scoring, not a mechanism promotion, not a baseline freeze, not hardware/native transfer, not public usefulness evidence, and not AGI/ASI evidence.",
        latest_manifest_names=("tier5_45_latest_manifest.json",),
        expected_extra_files=(
            "tier5_45_contract.json",
            "tier5_45_conditions.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier4_33_eoc_native_transfer_contract",
        tier_label="Tier 4.33 - Edge-of-Chaos Native Mechanism Transfer Contract",
        plan_position="Phase I hardware transfer: contract for v2.6 mechanism migration to SpiNNaker C runtime",
        canonical_dir="tier4_33_20260509_eoc_native_transfer_contract",
        results_file="tier4_33_results.json",
        report_file="tier4_33_report.md",
        summary_file="tier4_33_summary.csv",
        harness="experiments/tier4_33_eoc_native_transfer_contract.py",
        evidence_role="edge-of-chaos native mechanism transfer contract",
        claim="Tier 4.33 locks the edge-of-chaos native mechanism transfer protocol: 6 migration stages, state budget (~568 bytes DTCM), compute assessment (O(n^2) per tick, ~18k ops at n=128), 5 failure classes with repair strategies, DTCM resource risk documented (w_rec 64KB near limit). Contract only; no C implementation or hardware execution.",
        caveat="Contract only; not C implementation, not hardware evidence, not a baseline freeze. DTCM budget risk at n=128 may require n=64 for first hardware smoke.",
        latest_manifest_names=("tier4_33_latest_manifest.json",),
        expected_extra_files=(
            "tier4_33_contract.json", "tier4_33_stages.csv",
            "tier4_33_mechanism_spec.csv", "tier4_33_failures.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier7_7z_r3_nab_adapter",
        tier_label="Tier 7.7z-r3 - v2.6 NAB Streaming Anomaly Adapter",
        plan_position="Phase H usefulness: NAB adapter after v2.6 baseline freeze",
        canonical_dir="tier7_7z_r3_20260509_nab_adapter",
        results_file="tier7_7z_r3_results.json",
        report_file="tier7_7z_r3_report.md",
        summary_file="tier7_7z_r3_summary.csv",
        harness="experiments/tier7_7z_r3_nab_adapter.py",
        evidence_role="v2.6 NAB anomaly detection adapter",
        claim="Tier 7.7z-r3 applies v2.6 edge-of-chaos + ridge readout to 5 NAB streaming anomaly detection files, seeds 42/43/44. TravelTime_387 shows strong detection signal (1.56x error ratio, 3/3 seeds). Four other streams show weak/unreliable signal (1.02-1.19x). Ambient temperature is counter-signal (0.46x, model predicts better during anomalies). NAB partial/local signal — same pattern as v2.3. Consistent with bounded capability: edge-of-chaos helps chaotic/dynamic tasks but not gradual-drift anomaly patterns.",
        caveat="NAB adapter scoring only. Not a full NAB benchmark. Not public usefulness proof. Not a baseline freeze.",
        latest_manifest_names=("tier7_7z_r3_latest_manifest.json",),
        expected_extra_files=(
            "tier7_7z_r3_scoreboard.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier4_33a_eoc_fixed_point_reference",
        tier_label="Tier 4.33a - Edge-of-Chaos Fixed-Point Local Reference",
        plan_position="Phase I hardware transfer: fixed-point reference before C runtime implementation",
        canonical_dir="tier4_33a_20260509_eoc_fixed_point_reference",
        results_file="tier4_33a_results.json",
        report_file="tier4_33a_report.md",
        summary_file="tier4_33a_summary.csv",
        harness="experiments/tier4_33a_eoc_fixed_point_reference.py",
        evidence_role="fixed-point reference verification for edge-of-chaos mechanism",
        claim="Tier 4.33a verifies the edge-of-chaos mechanism in s16.15 fixed-point using FP_MUL (int64 intermediate, >>15) arithmetic matching the C runtime macro. FP_MUL arithmetic is correct (mean ratio 1.0111, 9/9 within 10%). Key finding: ARM float tanh is accurate enough; the C runtime can use standard math.h tanh rather than a fixed-point approximation. Ready for C runtime implementation.",
        caveat="Fixed-point reference only; not C runtime implementation, not hardware evidence, not a baseline freeze.",
        latest_manifest_names=("tier4_33a_latest_manifest.json",),
        expected_extra_files=(
            "tier4_33a_scoreboard.csv",
        ),
    ),
    EvidenceSpec(
        entry_id="tier4_33b_eoc_source_audit",
        tier_label="Tier 4.33b - EOC C Runtime Source Audit",
        plan_position="Phase I hardware transfer: C runtime source audit before EBRAINS package",
        canonical_dir="tier4_33b_20260509_eoc_source_audit",
        results_file="tier4_33b_results.json",
        report_file="tier4_33b_report.md",
        summary_file="tier4_33b_summary.csv",
        harness="experiments/tier4_33b_eoc_source_audit.py",
        evidence_role="C runtime source audit for edge-of-chaos mechanism",
        claim="Tier 4.33b verifies the edge-of-chaos mechanism is correctly integrated into the C runtime: PROFILE_EOC_RECURRENT defined in config.h, cra_eoc_init/update/get_summary implemented in state_manager.c with profile guard, eoc_recurrent profile added to Makefile with PROFILE_ID=7, host tests pass, and DTCM budget is 20KB at n=64 (w_rec 16KB + w_in 1KB + hidden 256B). Ready for EBRAINS package preparation.",
        caveat="Source audit only; not hardware build (spinnaker_tools not available locally), not EBRAINS execution, not a baseline freeze.",
        latest_manifest_names=("tier4_33b_latest_manifest.json",),
        expected_extra_files=(),
    ),
    EvidenceSpec(
        entry_id="tier5_21_nest_per_neuron_dimensionality_contract",
        tier_label="Tier 5.21 - NEST Per-Neuron State Dimensionality Diagnostic Contract",
        plan_position="Phase J NEST organism: per-neuron dimensionality diagnostic contract",
        canonical_dir="tier5_21_20260510_nest_per_neuron_dimensionality_contract",
        results_file="tier5_21_results.json",
        report_file="tier5_21_report.md",
        summary_file="tier5_21_summary.csv",
        harness="experiments/tier5_21_nest_per_neuron_dimensionality_contract.py",
        evidence_role="NEST organism per-neuron dimensionality diagnostic contract",
        claim="Tier 5.21 locks the NEST per-neuron state dimensionality diagnostic protocol. Question: does per-neuron spike PR exceed 4.0 at 16 polyps (512 channels) and exceed 2x per-polyp aggregate PR? Primary sham: shuffled neuron-to-polyp assignment. 4 outcome classes. Contract only; no scoring.",
        caveat="Contract only; not scoring, not mechanism promotion, not a baseline freeze, not public usefulness proof, not hardware/native transfer.",
        latest_manifest_names=("tier5_21_latest_manifest.json",),
        expected_extra_files=(
            "tier5_21_contract.json", "tier5_21_shams.csv",
            "tier5_21_outcomes.csv", "tier5_21_pass_criteria.csv",
            "tier5_21_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
        entry_id="tier5_22_within_polyp_per_neuron_diversity_contract",
        tier_label="Tier 5.22 - Within-Polyp Per-Neuron Input Diversity Diagnostic Contract",
        plan_position="Phase J NEST organism: within-polyp per-neuron diversity contract",
        canonical_dir="tier5_22_20260510_within_polyp_per_neuron_diversity_contract",
        results_file="tier5_22_results.json",
        report_file="tier5_22_report.md",
        summary_file="tier5_22_summary.csv",
        harness="experiments/tier5_22_within_polyp_per_neuron_diversity_contract.py",
        evidence_role="within-polyp per-neuron input diversity diagnostic contract",
        claim="Tier 5.22 locks the within-polyp per-neuron input diversity diagnostic. Mechanism: modify update_current_injections() to give each of 8 input neurons a different sensory gain (0.3x-1.5x) and amplify per-neuron biases to 15% of sensory ceiling. Primary pass: 16-polyp PR > 2.5 AND > 1.5x baseline. Sham: shuffled neuron gain assignment. 3 outcome classes. Contract only.",
        caveat="Contract only; not code implementation, not scoring, not mechanism promotion, not a baseline freeze.",
        latest_manifest_names=("tier5_22_latest_manifest.json",),
        expected_extra_files=(
            "tier5_22_contract.json", "tier5_22_outcomes.csv",
            "tier5_22_claim_boundary.md",
        ),
    ),
    EvidenceSpec(
