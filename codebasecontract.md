...
Active cleanup state:
  ...
  progress is 6/204 cells complete:
  organism_defaults_experimental_off sine and mackey_glass seeds 42, 43,
  and 44 passed 10/10 with zero fallback, zero sim.run failures, and
  zero summary-read failures. The current
