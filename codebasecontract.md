...
Active cleanup state:
  ...
  progress is 4/204 cells complete:
  organism_defaults_experimental_off sine seeds 42, 43, and 44 plus
  mackey_glass seed 42 passed 10/10 with zero fallback, zero sim.run
  failures, and zero summary-read failures. The current
