...
Active cleanup state:
  ...
  progress is 16/204 cells complete:
  ...
  completed sine seeds 42, 43, and 44 plus mackey_glass seed 42. All completed
  cells have zero fallback, zero sim.run failures, and zero summary-read
  failures. The current
