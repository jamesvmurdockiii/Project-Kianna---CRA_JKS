...
tier7-7c:
	python3 experiments/tier7_7c_standardized_long_run_failure_contract.py

tier7-7d:
	python3 experiments/tier7_7d_standardized_long_run_failure_scoring_gate.py

tier7-7d-smoke:
	python3 experiments/tier7_7d_standardized_long_run_failure_scoring_gate.py --smoke --output-dir controlled_test_output/tier7_7d_smoke

tier7-7e:
	python3 experiments/tier7_7e_finite_stream_repair_preflight.py

tier7-7f:
	python3 experiments/tier7_7f_repaired_finite_stream_long_run_scoreboard.py

tier7-7g:
	python3 experiments/tier7_7g_lorenz_capacity_narma_memory_contract.py

tier7-7h:
	python3 experiments/tier7_7h_lorenz_capacity_narma_memory_scoring_gate.py

tier7-7h-smoke:
	python3 experiments/tier7_7h_lorenz_capacity_narma_memory_scoring_gate.py --smoke --output-dir controlled_test_output/tier7_7h_smoke

tier7-7i:
	python3 experiments/tier7_7i_capacity_sham_separation_contract.py

tier7-7j:
	python3 experiments/tier7_7j_capacity_sham_separation_scoring_gate.py

tier7-7j-smoke:
	python3 experiments/tier7_7j_capacity_sham_separation_scoring_gate.py --smoke --output-dir controlled_test_output/tier7_7j_smoke

tier7-7k:
	python3 experiments/tier7_7k_effective_state_dimensionality_repair_contract.py

tier7-7l:
	python3 experiments/tier7_7l_effective_state_dimensionality_repair_scoring_gate.py

tier7-7l-smoke:
	python3 experiments/tier7_7l_effective_state_dimensionality_repair_scoring_gate.py --smoke --output-dir controlled_test_output/tier7_7l_smoke

tier7-7m:
	python3 experiments/tier7_7m_partitioned_driver_attribution_contract.py

tier7-7n:
	python3 experiments/tier7_7n_partitioned_driver_attribution_scoring_gate.py

tier7-7n-smoke:
	python3 experiments/tier7_7n_partitioned_driver_attribution_scoring_gate.py --smoke --output-dir controlled_test_output/tier7_7n_smoke

tier7-7o:
	python3 experiments/tier7_7o_generic_temporal_interface_reframing_contract.py

tier7-7p:
	python3 experiments/tier7_7p_cra_native_temporal_interface_internalization_contract.py

tier7-7q:
	python3 experiments/tier7_7q_cra_native_temporal_interface_internalization_scoring_gate.py

tier7-7q-smoke:
	python3 experiments/tier7_7q_cra_native_temporal_interface_internalization_scoring_gate.py --smoke --output-dir controlled_test_output/tier7_7q_smoke

tier7-7r:
	python3 experiments/tier7_7r_native_temporal_basis_reframing_contract.py
