...
Question: determine whether the 7.5c signal is true CRA mechanism value or
generator-feature alignment before any promotion, freeze, public-usefulness
claim, or hardware/native transfer.
```
