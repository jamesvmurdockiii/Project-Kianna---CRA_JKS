...
Question: decide whether the reduced-feature planning mechanism can be promoted
after compact regression, shams/ablations, and claim-boundary enforcement.
```
