...
Question: define the exact bounded planning/subgoal-control capability, tasks,
baselines, shams, leakage guards, metrics, pass/fail criteria, nonclaims, and
expected artifacts before any scoring.
```
