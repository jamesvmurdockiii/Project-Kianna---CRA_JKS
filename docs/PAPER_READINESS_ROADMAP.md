...
Question: rerun planning pressure with reduced feature access, held-out
composition variants, and stricter route/key attribution before any promotion or
freeze reopens.
```
