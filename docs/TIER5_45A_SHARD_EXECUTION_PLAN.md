...
```text
completed_cells = 12 / 204
completed = organism_defaults_experimental_off / sine,mackey_glass,lorenz,narma10 / seeds 42,43,44
...
next_pending = enable_neural_heritability / sine / seed 42
```
