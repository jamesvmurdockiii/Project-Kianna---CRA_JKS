...
- Generated: `2026-05-09T02:25:23.179033+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `111`
- Expanded evidence entries: `111`
...
| required baseline files exist | **PASS** | 84 files present |
| no transient generated clutter in repo tree | **PASS** | no .DS_Store, caches, or pyc files found |
| canonical registry exists and passes | **PASS** | 111 canonical bundles, 0 missing artifacts, 0 failed criteria |
