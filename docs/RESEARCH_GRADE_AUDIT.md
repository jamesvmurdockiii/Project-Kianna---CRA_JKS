...
- Generated: `2026-05-09T15:59:07.568281+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `134`
- Expanded evidence entries: `134`

## Checks

| Check | Status | Details |
| --- | --- | --- |
| required source documentation files exist | **PASS** | 14 files present |
...
| canonical registry exists and passes | **PASS** | 134 canonical bundles, 0 missing artifacts, 0 failed criteria |
