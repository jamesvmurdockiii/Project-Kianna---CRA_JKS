...
- Generated: `2026-05-16T19:49:52.215200+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `157`
- Expanded evidence entries: `157`

## Checks

| Check | Status | Details |
| --- | --- | --- |
| required source documentation files exist | **PASS** | 20 files present |
| required baseline files exist | **PASS** | 87 files present |
| no transient generated clutter in repo tree | **PASS** | no .DS_Store, caches, or pyc files found |
| canonical registry exists and passes | **PASS** | 157 canonical bundles, 0 missing artifacts, 0 failed criteria |
...
| frozen evidence baselines are intact | **PASS** | v0.1 through v2.4 baselines remain frozen at their recorded counts |
| current docs have no stale evidence-count claims | **PASS** | no stale current evidence-count claims outside frozen baselines |
| public-facing docs avoid machine-local absolute paths | **PASS** | no machine-local absolute paths found in public-facing docs |
| public docs avoid private/hype/profane language | **PASS** | no private/hype/profane terms found in scanned docs |
| README relative links resolve | **PASS** | all README relative links resolve |
| raw hardware/download artifacts are not tracked | **PASS** | no tracked reports.zip, sqlite provenance DBs, stack traces, raw downloads, nested upload bundles, or compiled SpiNNaker binaries |
| tracked files avoid machine-local absolute paths | **PASS** | no tracked file contains machine-local absolute path patterns |
| no oversized tracked blobs | **PASS** | no tracked file exceeds 50 MiB |
