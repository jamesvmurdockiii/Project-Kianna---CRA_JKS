...
- Generated: `2026-05-05T22:20:15.845360+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `57`
- Expanded evidence entries: `57`
...
| required baseline files exist | **PASS** | 66 files present |
| no transient generated clutter in repo tree | **PASS** | no .DS_Store, caches, or pyc files found |
| canonical registry exists and passes | **PASS** | 57 canonical bundles, 0 missing artifacts, 0 failed criteria |
