...
- Generated: `2026-05-08T19:15:25.061120+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `85`
- Expanded evidence entries: `85`
...
| required baseline files exist | **PASS** | 78 files present |
| no transient generated clutter in repo tree | **PASS** | no .DS_Store, caches, or pyc files found |
| canonical registry exists and passes | **PASS** | 85 canonical bundles, 0 missing artifacts, 0 failed criteria |
