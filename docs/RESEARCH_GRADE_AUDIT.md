...
- Generated: `2026-05-08T23:36:07.619076+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `103`
- Expanded evidence entries: `103`
...
| required baseline files exist | **PASS** | 81 files present |
| no transient generated clutter in repo tree | **PASS** | no .DS_Store, caches, or pyc files found |
| canonical registry exists and passes | **PASS** | 103 canonical bundles, 0 missing artifacts, 0 failed criteria |
