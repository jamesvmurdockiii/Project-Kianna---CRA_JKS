...
- Generated: `2026-05-05T13:13:35.203767+00:00`
- Status: **PASS**
- Registry status: `pass`
- Canonical evidence bundles: `42`
- Expanded evidence entries: `42`
...
| required baseline files exist | **PASS** | 63 files present |
| no transient generated clutter in repo tree | **PASS** | no .DS_Store, caches, or pyc files found |
| canonical registry exists and passes | **PASS** | 27 canonical bundles, 27 entries, 0 missing artifacts, 0 failed criteria |
...
| frozen evidence baselines are intact | **PASS** | v0.1 through v2.1 baselines remain frozen at their recorded counts |
