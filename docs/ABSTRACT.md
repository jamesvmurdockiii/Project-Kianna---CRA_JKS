...
As of the current registry, CRA contains 64 canonical evidence bundles with zero
...
selected seven-EMA temporal subset, and Tier 4.31c local C/runtime ownership of
that subset before hardware smoke.
