...
Upload the `cra_428e` folder itself so the JobManager path starts
with `cra_428e/`.
...
```text
cra_428e/experiments/tier4_28a_four_core_mcpl_repeatability.py --mode run-hardware --seed 42
```
