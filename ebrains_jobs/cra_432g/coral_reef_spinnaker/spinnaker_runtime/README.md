...
make test-mcpl-lifecycle-interchip-route-contract # Tier 4.32g-r0 lifecycle route-link contract
make test-mcpl-lifecycle-receive-contract # Tier 4.32g lifecycle receive semantics contract
...
CRA_MCPL_INTERCHIP_LIFECYCLE_REQUEST_LINK_ROUTE # learning-core outbound lifecycle request link
CRA_MCPL_INTERCHIP_LIFECYCLE_SYNC_LINK_ROUTE    # lifecycle-core outbound active-mask/lineage sync link
```
...
Tier 4.32g extends the lifecycle route surface. `learning_core` can accept
