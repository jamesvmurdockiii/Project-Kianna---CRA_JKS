...
Upload the `cra_429a` folder itself so the JobManager path starts
with `cra_429a/`.
...
```text
cra_429a/experiments/tier4_29a_native_keyed_memory_overcapacity_gate.py --mode run-hardware --seeds 42,43,44
```

## Alternative: single-seed command

```text
cra_429a/experiments/tier4_29a_native_keyed_memory_overcapacity_gate.py --mode run-hardware --seed 42
```
