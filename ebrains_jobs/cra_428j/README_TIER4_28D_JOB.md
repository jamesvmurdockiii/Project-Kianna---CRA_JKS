...
Upload the `cra_428j` folder itself so the JobManager path starts
with `cra_428j/`.
...
```text
cra_428j/experiments/tier4_28d_hard_noisy_switching_four_core_mcpl.py --mode run-hardware --seeds 42,43,44
```
...
```text
cra_428j/experiments/tier4_28d_hard_noisy_switching_four_core_mcpl.py --mode run-hardware --seed 42
```
