...
RUNNER_REVISION = "tier4_22w_native_decoupled_memory_route_composition_smoke_20260501_0002_runtime_profile"
...
UPLOAD_PACKAGE_NAME = "cra_422ag"
STABLE_EBRAINS_UPLOAD = ROOT / "ebrains_jobs" / UPLOAD_PACKAGE_NAME
DEPRECATED_EBRAINS_UPLOADS = [ROOT / "ebrains_jobs" / "cra_422af", ROOT / "ebrains_jobs" / "cra_422af_old"]
...
def build_aplx_for_tier(output_dir: Path) -> dict[str, Any]:
    ...
    runtime_profile_path = output_dir / "tier4_22w_runtime_profile.json"
    ...
    result = {
        ...
        "artifacts": {
            **reference_artifacts,
            ...
            "runtime_profile_json": str(output_dir / "tier4_22w_runtime_profile.json"),
