...
Upload the `cra_428c` folder itself so the JobManager path starts
with `cra_428c/`.
...
```text
cra_428c/experiments/tier4_28a_four_core_mcpl_repeatability.py --mode run-hardware --seed 42
```

Default output dir is `tier4_28a_seed42_job_output`.
