...
Upload the `cra_428b` folder itself so the JobManager path starts
with `cra_428b/`.
...
```text
cra_428b/experiments/tier4_28a_four_core_mcpl_repeatability.py --mode run-hardware --seed 42
```
