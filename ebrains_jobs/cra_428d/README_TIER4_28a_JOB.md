...
Upload the `cra_428d` folder itself so the JobManager path starts
with `cra_428d/`.
...
```text
cra_428d/experiments/tier4_28a_four_core_mcpl_repeatability.py --mode run-hardware --seed 42
```
